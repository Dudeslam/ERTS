...
xv_path="D:/Programmer/Xilinx/Vivado/2017.2"
...
{
  file="xsim.ini"
  lib_map_path="D:/Programmer/Xilinx/Vivado/2017.2/data/xsim"
  if [[ ($1 != "") ]]; then
    lib_map_path="$1"
  fi
