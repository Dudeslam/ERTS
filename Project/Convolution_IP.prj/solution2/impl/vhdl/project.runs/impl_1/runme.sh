...
HD_PWD='C:/Users/Kristoffer/Documents/Embedded_Real_Time_Exercises/Project/Convolution_IP.prj/solution2/impl/vhdl/project.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log conv_3x3_strm.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source conv_3x3_strm.tcl -notrace
