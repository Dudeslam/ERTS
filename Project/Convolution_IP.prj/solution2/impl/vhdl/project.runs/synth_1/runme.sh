...
HD_PWD='C:/Users/Kristoffer/Documents/Embedded_Real_Time_Exercises/Project/Convolution_IP.prj/solution2/impl/vhdl/project.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log conv_3x3_strm.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source conv_3x3_strm.tcl
