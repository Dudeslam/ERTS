...
@.str5 = private unnamed_addr constant [12 x i8] c"for_j_pixel\00", align 1 ; [#uses=3 type=[12 x i8]*]
@.str4 = private unnamed_addr constant [12 x i8] c"for_i_pixel\00", align 1 ; [#uses=3 type=[12 x i8]*]
@.str3 = private unnamed_addr constant [15 x i8] c"init_linebuf_2\00", align 1 ; [#uses=3 type=[15 x i8]*]
@.str2 = private unnamed_addr constant [15 x i8] c"init_linebuf_1\00", align 1 ; [#uses=3 type=[15 x i8]*]
...
; [#uses=0]
define void @conv_3x3_strm(i8* %out_stream.V, i8* %in_stream.V) {
  %1 = call i32 (...)* @_ssdm_op_SpecInterface(i8* %in_stream.V, [8 x i8]* @ap_fifo.str, i32 0, i32 0, [1 x i8]* @.str, i32 0, i32 0, [1 x i8]* @.str, [1 x i8]* @.str, [1 x i8]* @.str, i32 2, i32 2, i32 16, i32 16, [1 x i8]* @.str, [1 x i8]* @.str) ; [#uses=0 type=i32]
  %2 = call i32 (...)* @_ssdm_op_SpecInterface(i8* %out_stream.V, [8 x i8]* @ap_fifo.str, i32 0, i32 0, [1 x i8]* @.str, i32 0, i32 0, [1 x i8]* @.str, [1 x i8]* @.str, [1 x i8]* @.str, i32 2, i32 2, i32 16, i32 16, [1 x i8]* @.str, [1 x i8]* @.str) ; [#uses=0 type=i32]
  call void (...)* @_ssdm_op_SpecBitsMap(i8* %out_stream.V), !map !2799
  call void (...)* @_ssdm_op_SpecBitsMap(i8* %in_stream.V), !map !2803
  ...
  %"line_buf[0]" = alloca [256 x i8], align 1     ; [#uses=4 type=[256 x i8]*]
  %"line_buf[1]" = alloca [256 x i8], align 1     ; [#uses=4 type=[256 x i8]*]
  call void @llvm.dbg.value(metadata !{i8* %out_stream.V}, i64 0, metadata !2807), !dbg !2812 ; [debug line = 42:41] [debug variable = out_stream.V]
  call void @llvm.dbg.value(metadata !{i8* %in_stream.V}, i64 0, metadata !2813), !dbg !2815 ; [debug line = 42:74] [debug variable = in_stream.V]
  call void @llvm.dbg.declare(metadata !{[256 x i8]* %"line_buf[0]"}, metadata !2816), !dbg !2823 ; [debug line = 45:9] [debug variable = line_buf[0]]
  call void @llvm.dbg.declare(metadata !{[256 x i8]* %"line_buf[1]"}, metadata !2824), !dbg !2823 ; [debug line = 45:9] [debug variable = line_buf[1]]
  br label %3, !dbg !2825                         ; [debug line = 57:39]

; <label>:3                                       ; preds = %5, %0
  %x = phi i9 [ 254, %0 ], [ %x.1, %5 ]           ; [#uses=3 type=i9]
  %exitcond1 = icmp eq i9 %x, -256, !dbg !2825    ; [#uses=1 type=i1] [debug line = 57:39]
  %4 = call i32 (...)* @_ssdm_op_SpecLoopTripCount(i64 2, i64 2, i64 2) ; [#uses=0 type=i32]
  br i1 %exitcond1, label %.preheader14.preheader, label %5, !dbg !2825 ; [debug line = 57:39]

.preheader14.preheader:                           ; preds = %3
  br label %.preheader14, !dbg !2827              ; [debug line = 62:33]

; <label>:5                                       ; preds = %3
  call void (...)* @_ssdm_op_SpecLoopName([15 x i8]* @.str2) nounwind, !dbg !2829 ; [debug line = 57:55]
  %tmp.5 = call i32 (...)* @_ssdm_op_SpecRegionBegin([15 x i8]* @.str2), !dbg !2829 ; [#uses=1 type=i32] [debug line = 57:55]
  call void (...)* @_ssdm_op_SpecPipeline(i32 -1, i32 1, i32 1, i32 0, [1 x i8]* @.str1) nounwind, !dbg !2831 ; [debug line = 58:1]
  call void @llvm.dbg.value(metadata !{i8* %in_stream.V}, i64 0, metadata !2832), !dbg !2836 ; [debug line = 129:56@59:19] [debug variable = stream<unsigned char>.V]
  call void @llvm.dbg.declare(metadata !{i8* %tmp}, metadata !2838) nounwind, !dbg !2840 ; [debug line = 130:22@59:19] [debug variable = tmp]
  call void @_ssdm_op_IfRead.Stream.i8P.i8P(i8* %in_stream.V, i8* %tmp) nounwind, !dbg !2841 ; [debug line = 131:9@59:19]
  call void @llvm.dbg.value(metadata !{i8* %tmp}, i64 0, metadata !2838), !dbg !2842 ; [debug line = 132:9@59:19] [debug variable = tmp]
  call void @llvm.dbg.value(metadata !{i8* %tmp}, i64 0, metadata !2838), !dbg !2842 ; [debug line = 132:9@59:19] [debug variable = tmp]
  %6 = load i8* %tmp, align 1, !dbg !2842         ; [#uses=1 type=i8] [debug line = 132:9@59:19]
  %tmp.1 = zext i9 %x to i64, !dbg !2837          ; [#uses=1 type=i64] [debug line = 59:19]
  %"line_buf[0].addr" = getelementptr [256 x i8]* %"line_buf[0]", i64 0, i64 %tmp.1 ; [#uses=1 type=i8*]
  store i8 %6, i8* %"line_buf[0].addr", align 1, !dbg !2837 ; [debug line = 59:19]
  %7 = call i32 (...)* @_ssdm_op_SpecRegionEnd([15 x i8]* @.str2, i32 %tmp.5), !dbg !2843 ; [#uses=0 type=i32] [debug line = 60:5]
  %x.1 = add i9 %x, 1, !dbg !2844                 ; [#uses=1 type=i9] [debug line = 57:50]
  call void @llvm.dbg.value(metadata !{i9 %x.1}, i64 0, metadata !2845), !dbg !2844 ; [debug line = 57:50] [debug variable = x]
  br label %3, !dbg !2844                         ; [debug line = 57:50]

.preheader14:                                     ; preds = %9, %.preheader14.preheader
  %x1 = phi i9 [ %x.2, %9 ], [ 0, %.preheader14.preheader ] ; [#uses=3 type=i9]
  %exitcond2 = icmp eq i9 %x1, -256, !dbg !2827   ; [#uses=1 type=i1] [debug line = 62:33]
  %8 = call i32 (...)* @_ssdm_op_SpecLoopTripCount(i64 256, i64 256, i64 256) ; [#uses=0 type=i32]
  br i1 %exitcond2, label %11, label %9, !dbg !2827 ; [debug line = 62:33]

; <label>:9                                       ; preds = %.preheader14
  call void (...)* @_ssdm_op_SpecLoopName([15 x i8]* @.str3) nounwind, !dbg !2846 ; [debug line = 62:49]
  %tmp.7 = call i32 (...)* @_ssdm_op_SpecRegionBegin([15 x i8]* @.str3), !dbg !2846 ; [#uses=1 type=i32] [debug line = 62:49]
  call void (...)* @_ssdm_op_SpecPipeline(i32 -1, i32 1, i32 1, i32 0, [1 x i8]* @.str1) nounwind, !dbg !2848 ; [debug line = 63:1]
  call void @llvm.dbg.value(metadata !{i8* %in_stream.V}, i64 0, metadata !2832), !dbg !2849 ; [debug line = 129:56@64:19] [debug variable = stream<unsigned char>.V]
  call void @llvm.dbg.declare(metadata !{i8* %tmp.2}, metadata !2838) nounwind, !dbg !2851 ; [debug line = 130:22@64:19] [debug variable = tmp]
  call void @_ssdm_op_IfRead.Stream.i8P.i8P(i8* %in_stream.V, i8* %tmp.2) nounwind, !dbg !2852 ; [debug line = 131:9@64:19]
  call void @llvm.dbg.value(metadata !{i8* %tmp.2}, i64 0, metadata !2838), !dbg !2853 ; [debug line = 132:9@64:19] [debug variable = tmp]
  call void @llvm.dbg.value(metadata !{i8* %tmp.2}, i64 0, metadata !2838), !dbg !2853 ; [debug line = 132:9@64:19] [debug variable = tmp]
  %tmp.2.load = load i8* %tmp.2, align 1, !dbg !2853 ; [#uses=1 type=i8] [debug line = 132:9@64:19]
  %tmp.4 = zext i9 %x1 to i64, !dbg !2850         ; [#uses=1 type=i64] [debug line = 64:19]
  %"line_buf[1].addr.2" = getelementptr [256 x i8]* %"line_buf[1]", i64 0, i64 %tmp.4 ; [#uses=1 type=i8*]
  store i8 %tmp.2.load, i8* %"line_buf[1].addr.2", align 1, !dbg !2850 ; [debug line = 64:19]
  %10 = call i32 (...)* @_ssdm_op_SpecRegionEnd([15 x i8]* @.str3, i32 %tmp.7), !dbg !2854 ; [#uses=0 type=i32] [debug line = 65:5]
  %x.2 = add i9 %x1, 1, !dbg !2855                ; [#uses=1 type=i9] [debug line = 62:44]
  call void @llvm.dbg.value(metadata !{i9 %x.2}, i64 0, metadata !2856), !dbg !2855 ; [debug line = 62:44] [debug variable = x]
  br label %.preheader14, !dbg !2855              ; [debug line = 62:44]

; <label>:11                                      ; preds = %.preheader14
  %"line_buf[0].addr.1" = getelementptr [256 x i8]* %"line_buf[0]", i64 0, i64 254 ; [#uses=1 type=i8*]
  %"window[1][1]" = load i8* %"line_buf[0].addr.1", align 2, !dbg !2857 ; [#uses=1 type=i8] [debug line = 69:2]
  call void @llvm.dbg.value(metadata !{i8 %"window[1][1]"}, i64 0, metadata !2858), !dbg !2857 ; [debug line = 69:2] [debug variable = window[1][1]]
  %"line_buf[0].addr.2" = getelementptr [256 x i8]* %"line_buf[0]", i64 0, i64 255 ; [#uses=1 type=i8*]
  %"window[1][2]" = load i8* %"line_buf[0].addr.2", align 1, !dbg !2861 ; [#uses=1 type=i8] [debug line = 70:2]
  call void @llvm.dbg.value(metadata !{i8 %"window[1][2]"}, i64 0, metadata !2862), !dbg !2861 ; [debug line = 70:2] [debug variable = window[1][2]]
  %"line_buf[1].addr" = getelementptr [256 x i8]* %"line_buf[1]", i64 0, i64 254 ; [#uses=1 type=i8*]
  %"window[2][1]" = load i8* %"line_buf[1].addr", align 2, !dbg !2863 ; [#uses=1 type=i8] [debug line = 71:2]
  call void @llvm.dbg.value(metadata !{i8 %"window[2][1]"}, i64 0, metadata !2864), !dbg !2863 ; [debug line = 71:2] [debug variable = window[2][1]]
  %"line_buf[1].addr.1" = getelementptr [256 x i8]* %"line_buf[1]", i64 0, i64 255 ; [#uses=1 type=i8*]
  %"window[2][2]" = load i8* %"line_buf[1].addr.1", align 1, !dbg !2865 ; [#uses=1 type=i8] [debug line = 72:2]
  call void @llvm.dbg.value(metadata !{i8 %"window[2][2]"}, i64 0, metadata !2866), !dbg !2865 ; [debug line = 72:2] [debug variable = window[2][2]]
  br label %12, !dbg !2867                        ; [debug line = 76:30]

; <label>:12                                      ; preds = %18, %11
  %window.2.2 = phi i8 [ %"window[2][2]", %11 ], [ %"window[2][1].1.lcssa", %18 ] ; [#uses=1 type=i8]
  %window.2.1 = phi i8 [ %"window[2][1]", %11 ], [ %"window[2][0].lcssa", %18 ] ; [#uses=1 type=i8]
  %window.2.0. = phi i8 [ undef, %11 ], [ %window.2.0.1.lcssa, %18 ] ; [#uses=1 type=i8]
  %window.1.2 = phi i8 [ %"window[1][2]", %11 ], [ %"window[1][1].1.lcssa", %18 ] ; [#uses=1 type=i8]
  %window.1.1 = phi i8 [ %"window[1][1]", %11 ], [ %"window[1][0].lcssa", %18 ] ; [#uses=1 type=i8]
  %window.1.0. = phi i8 [ undef, %11 ], [ %window.1.0.1.lcssa, %18 ] ; [#uses=1 type=i8]
  %window.0.2. = phi i8 [ undef, %11 ], [ %"window[0][1].lcssa", %18 ] ; [#uses=1 type=i8]
  %window.0.1. = phi i8 [ undef, %11 ], [ %"window[0][0].lcssa", %18 ] ; [#uses=1 type=i8]
  %window.0.0. = phi i8 [ undef, %11 ], [ %window.0.0.1.lcssa, %18 ] ; [#uses=1 type=i8]
  %read_count = phi i32 [ 258, %11 ], [ %read_count.1.lcssa, %18 ] ; [#uses=1 type=i32]
  %y.assign = phi i9 [ 0, %11 ], [ %y.assign.1, %18 ] ; [#uses=4 type=i9]
  %exitcond3 = icmp eq i9 %y.assign, -256, !dbg !2867 ; [#uses=1 type=i1] [debug line = 76:30]
  %13 = call i32 (...)* @_ssdm_op_SpecLoopTripCount(i64 256, i64 256, i64 256) ; [#uses=0 type=i32]
  br i1 %exitcond3, label %20, label %14, !dbg !2867 ; [debug line = 76:30]

; <label>:14                                      ; preds = %12
  call void (...)* @_ssdm_op_SpecLoopName([12 x i8]* @.str4) nounwind, !dbg !2869 ; [debug line = 77:3]
  %tmp.8 = call i32 (...)* @_ssdm_op_SpecRegionBegin([12 x i8]* @.str4), !dbg !2869 ; [#uses=1 type=i32] [debug line = 77:3]
  %tmp.i = icmp ne i9 %y.assign, 0, !dbg !2871    ; [#uses=2 type=i1] [debug line = 19:2@30:9@83:24]
  %y.assign.1 = add i9 %y.assign, 1, !dbg !2873   ; [#uses=2 type=i9] [debug line = 30:9@83:24]
  %tmp..i1 = icmp sgt i9 %y.assign.1, -1, !dbg !2871 ; [#uses=2 type=i1] [debug line = 19:2@30:9@83:24]
  %y.assign.2 = add i9 %y.assign, 2, !dbg !2873   ; [#uses=1 type=i9] [debug line = 30:9@83:24]
  %tmp..i2 = icmp sgt i9 %y.assign.2, -1, !dbg !2871 ; [#uses=2 type=i1] [debug line = 19:2@30:9@83:24]
  br label %15, !dbg !2882                        ; [debug line = 78:31]

; <label>:15                                      ; preds = %.loopexit, %14
  %"window[2][1].1" = phi i8 [ %window.2.2, %14 ], [ %window.2.2.2, %.loopexit ] ; [#uses=4 type=i8]
  %"window[2][0]" = phi i8 [ %window.2.1, %14 ], [ %window.2.1.2, %.loopexit ] ; [#uses=3 type=i8]
  %window.2.0.1 = phi i8 [ %window.2.0., %14 ], [ %window.2.0.2, %.loopexit ] ; [#uses=3 type=i8]
  %"window[1][1].1" = phi i8 [ %window.1.2, %14 ], [ %window.1.2.2, %.loopexit ] ; [#uses=4 type=i8]
  %"window[1][0]" = phi i8 [ %window.1.1, %14 ], [ %window.1.1.2, %.loopexit ] ; [#uses=3 type=i8]
  %window.1.0.1 = phi i8 [ %window.1.0., %14 ], [ %window.1.0.2, %.loopexit ] ; [#uses=3 type=i8]
  %"window[0][1]" = phi i8 [ %window.0.2., %14 ], [ %window.0.2.2, %.loopexit ] ; [#uses=4 type=i8]
  %"window[0][0]" = phi i8 [ %window.0.1., %14 ], [ %window.0.1.2, %.loopexit ] ; [#uses=3 type=i8]
  %window.0.0.1 = phi i8 [ %window.0.0., %14 ], [ %window.0.0.2, %.loopexit ] ; [#uses=3 type=i8]
  %read_count.1 = phi i32 [ %read_count, %14 ], [ %read_count.2, %.loopexit ] ; [#uses=4 type=i32]
  %x.assign = phi i9 [ 0, %14 ], [ %x.assign.3, %.loopexit ] ; [#uses=5 type=i9]
  %exitcond4 = icmp eq i9 %x.assign, -256, !dbg !2882 ; [#uses=1 type=i1] [debug line = 78:31]
  %16 = call i32 (...)* @_ssdm_op_SpecLoopTripCount(i64 256, i64 256, i64 256) ; [#uses=0 type=i32]
  br i1 %exitcond4, label %18, label %.preheader.preheader.i.0_ifconv, !dbg !2882 ; [debug line = 78:31]

.preheader.preheader.i.0_ifconv:                  ; preds = %15
  call void (...)* @_ssdm_op_SpecLoopName([12 x i8]* @.str5) nounwind, !dbg !2883 ; [debug line = 79:4]
  %tmp.9 = call i32 (...)* @_ssdm_op_SpecRegionBegin([12 x i8]* @.str5), !dbg !2883 ; [#uses=1 type=i32] [debug line = 79:4]
  call void (...)* @_ssdm_op_SpecPipeline(i32 -1, i32 1, i32 1, i32 0, [1 x i8]* @.str1) nounwind, !dbg !2884 ; [debug line = 80:1]
  call void @llvm.dbg.value(metadata !{i9 %y.assign}, i64 0, metadata !2885) nounwind, !dbg !2886 ; [debug line = 24:57@83:24] [debug variable = y]
  call void @llvm.dbg.value(metadata !{i9 %x.assign}, i64 0, metadata !2887) nounwind, !dbg !2888 ; [debug line = 24:64@83:24] [debug variable = x]
  call void @llvm.dbg.value(metadata !{i9 %y.assign}, i64 0, metadata !2889), !dbg !2890 ; [debug line = 18:21@30:9@83:24] [debug variable = y]
  call void @llvm.dbg.value(metadata !{i9 %x.assign}, i64 0, metadata !2891), !dbg !2892 ; [debug line = 18:28@30:9@83:24] [debug variable = x]
  %tmp.1.i = icmp ne i9 %x.assign, 0, !dbg !2871  ; [#uses=2 type=i1] [debug line = 19:2@30:9@83:24]
  %or.cond1.i = and i1 %tmp.i, %tmp.1.i, !dbg !2871 ; [#uses=1 type=i1] [debug line = 19:2@30:9@83:24]
  %tmp.151.cast = zext i8 %window.0.0.1 to i9, !dbg !2893 ; [#uses=1 type=i9] [debug line = 31:6@83:24]
  %tmp.16 = sub i9 0, %tmp.151.cast, !dbg !2893   ; [#uses=1 type=i9] [debug line = 31:6@83:24]
  %result.2.i = select i1 %or.cond1.i, i9 %tmp.16, i9 0 ; [#uses=1 type=i9]
  %x.assign.3 = add i9 %x.assign, 1, !dbg !2873   ; [#uses=2 type=i9] [debug line = 30:9@83:24]
  call void @llvm.dbg.value(metadata !{i9 %x.assign.3}, i64 0, metadata !2891), !dbg !2892 ; [debug line = 18:28@30:9@83:24] [debug variable = x]
  %tmp.2.i1 = icmp sgt i9 %x.assign.3, -1, !dbg !2871 ; [#uses=1 type=i1] [debug line = 19:2@30:9@83:24]
  %tmp1 = and i1 %tmp.2.i1, %tmp.1.i, !dbg !2873  ; [#uses=1 type=i1] [debug line = 30:9@83:24]
  %brmerge.demorgan.i.0.1 = and i1 %tmp1, %tmp.i, !dbg !2873 ; [#uses=2 type=i1] [debug line = 30:9@83:24]
  %result.2.i.0.0. = select i1 %brmerge.demorgan.i.0.1, i9 %result.2.i, i9 0, !dbg !2873 ; [#uses=1 type=i9] [debug line = 30:9@83:24]
  %x.assign.2 = add i9 %x.assign, 2, !dbg !2873   ; [#uses=1 type=i9] [debug line = 30:9@83:24]
  call void @llvm.dbg.value(metadata !{i9 %x.assign.2}, i64 0, metadata !2891), !dbg !2892 ; [debug line = 18:28@30:9@83:24] [debug variable = x]
  %tmp.2.i2 = icmp sgt i9 %x.assign.2, -1, !dbg !2871 ; [#uses=1 type=i1] [debug line = 19:2@30:9@83:24]
  %brmerge.demorgan.i.0.2 = and i1 %brmerge.demorgan.i.0.1, %tmp.2.i2, !dbg !2873 ; [#uses=3 type=i1] [debug line = 30:9@83:24]
  %tmp.15.0.2.cast = zext i8 %"window[0][1]" to i9, !dbg !2893 ; [#uses=1 type=i9] [debug line = 31:6@83:24]
  %result.0.2 = add i9 %tmp.15.0.2.cast, %result.2.i.0.0., !dbg !2893 ; [#uses=1 type=i9] [debug line = 31:6@83:24]
  %result.2.i.0.2 = select i1 %brmerge.demorgan.i.0.2, i9 %result.0.2, i9 0 ; [#uses=1 type=i9]
  %result.2.i.0.2.cast = sext i9 %result.2.i.0.2 to i11 ; [#uses=1 type=i11]
  call void @llvm.dbg.value(metadata !{i9 %y.assign.1}, i64 0, metadata !2889), !dbg !2890 ; [debug line = 18:21@30:9@83:24] [debug variable = y]
  %brmerge.demorgan.i.1 = and i1 %tmp..i1, %brmerge.demorgan.i.0.2, !dbg !2873 ; [#uses=3 type=i1] [debug line = 30:9@83:24]
  %tmp.15.1.cast = zext i8 %window.1.0.1 to i9, !dbg !2893 ; [#uses=1 type=i9] [debug line = 31:6@83:24]
  %_shl = shl nuw i9 %tmp.15.1.cast, 1, !dbg !2893 ; [#uses=1 type=i9] [debug line = 31:6@83:24]
  %_shl.cast = zext i9 %_shl to i11, !dbg !2893   ; [#uses=1 type=i11] [debug line = 31:6@83:24]
  %result.1 = sub i11 %result.2.i.0.2.cast, %_shl.cast, !dbg !2893 ; [#uses=1 type=i11] [debug line = 31:6@83:24]
  %result.2.i.1.0. = select i1 %brmerge.demorgan.i.1, i11 %result.1, i11 0, !dbg !2873 ; [#uses=1 type=i11] [debug line = 30:9@83:24]
  %tmp.15.1.2.cast = zext i8 %"window[1][1].1" to i9, !dbg !2893 ; [#uses=1 type=i9] [debug line = 31:6@83:24]
  %tmp.16.1.2 = shl nuw i9 %tmp.15.1.2.cast, 1, !dbg !2893 ; [#uses=1 type=i9] [debug line = 31:6@83:24]
  %tmp.16.1.2.cast = zext i9 %tmp.16.1.2 to i11, !dbg !2893 ; [#uses=1 type=i11] [debug line = 31:6@83:24]
  %result.1.2 = add i11 %tmp.16.1.2.cast, %result.2.i.1.0., !dbg !2893 ; [#uses=1 type=i11] [debug line = 31:6@83:24]
  %result.2.i.1.2 = select i1 %brmerge.demorgan.i.1, i11 %result.1.2, i11 0 ; [#uses=1 type=i11]
  call void @llvm.dbg.value(metadata !{i9 %y.assign.2}, i64 0, metadata !2889), !dbg !2890 ; [debug line = 18:21@30:9@83:24] [debug variable = y]
  %brmerge.demorgan.i.2 = and i1 %tmp..i2, %brmerge.demorgan.i.1, !dbg !2873 ; [#uses=1 type=i1] [debug line = 30:9@83:24]
  %tmp.15.2.cast = zext i8 %window.2.0.1 to i11, !dbg !2893 ; [#uses=1 type=i11] [debug line = 31:6@83:24]
  %result.2 = sub i11 %result.2.i.1.2, %tmp.15.2.cast, !dbg !2893 ; [#uses=1 type=i11] [debug line = 31:6@83:24]
  %result.2.i.2 = select i1 %brmerge.demorgan.i.2, i11 %result.2, i11 0 ; [#uses=1 type=i11]
  %tmp2 = and i1 %tmp..i1, %brmerge.demorgan.i.0.2, !dbg !2873 ; [#uses=1 type=i1] [debug line = 30:9@83:24]
  %brmerge.demorgan.i.2.1 = and i1 %tmp2, %tmp..i2, !dbg !2873 ; [#uses=2 type=i1] [debug line = 30:9@83:24]
  %result.2.i.2.0. = select i1 %brmerge.demorgan.i.2.1, i11 %result.2.i.2, i11 0, !dbg !2873 ; [#uses=1 type=i11] [debug line = 30:9@83:24]
  %tmp.15.2.2.cast = zext i8 %"window[2][1].1" to i11, !dbg !2893 ; [#uses=1 type=i11] [debug line = 31:6@83:24]
  %result.2.2 = add i11 %tmp.15.2.2.cast, %result.2.i.2.0., !dbg !2893 ; [#uses=1 type=i11] [debug line = 31:6@83:24]
  %result.2.i.2.2 = select i1 %brmerge.demorgan.i.2.1, i11 %result.2.2, i11 0 ; [#uses=4 type=i11]
  %tmp.17 = lshr i11 %result.2.i.2.2, 10, !dbg !2879 ; [#uses=1 type=i11] [debug line = 83:24]
  %tmp.18 = trunc i11 %tmp.17 to i1, !dbg !2879   ; [#uses=1 type=i1] [debug line = 83:24]
  %_neg = sub i11 0, %result.2.i.2.2, !dbg !2879  ; [#uses=1 type=i11] [debug line = 83:24]
  %_lshr = lshr i11 %_neg, 2, !dbg !2879          ; [#uses=1 type=i11] [debug line = 83:24]
  %tmp.11 = trunc i11 %_lshr to i8, !dbg !2879    ; [#uses=1 type=i8] [debug line = 83:24]
  %tmp.19 = lshr i11 %result.2.i.2.2, 2, !dbg !2879 ; [#uses=1 type=i11] [debug line = 83:24]
  %tmp.12 = sub i8 0, %tmp.11, !dbg !2879         ; [#uses=1 type=i8] [debug line = 83:24]
  %tmp.13 = trunc i11 %tmp.19 to i8, !dbg !2879   ; [#uses=1 type=i8] [debug line = 83:24]
  %tmp.14 = select i1 %tmp.18, i8 %tmp.12, i8 %tmp.13, !dbg !2879 ; [#uses=2 type=i8] [debug line = 83:24]
  %abscond = icmp sgt i11 %result.2.i.2.2, 3      ; [#uses=1 type=i1]
  %tmp.15 = sub i8 0, %tmp.14                     ; [#uses=1 type=i8]
  %val_out = select i1 %abscond, i8 %tmp.14, i8 %tmp.15 ; [#uses=1 type=i8]
  call void @llvm.dbg.value(metadata !{i8 %val_out}, i64 0, metadata !2895), !dbg !2879 ; [debug line = 83:24] [debug variable = val_out]
  call void @llvm.dbg.value(metadata !{i8* %out_stream.V}, i64 0, metadata !2896), !dbg !2898 ; [debug line = 144:48@85:4] [debug variable = stream<unsigned char>.V]
  call void @llvm.dbg.declare(metadata !{i8* %tmp.3}, metadata !2900) nounwind, !dbg !2902 ; [debug line = 145:22@85:4] [debug variable = tmp]
  call void @llvm.dbg.value(metadata !{i8 %val_out}, i64 0, metadata !2900), !dbg !2903 ; [debug line = 145:31@85:4] [debug variable = tmp]
  call void @llvm.dbg.value(metadata !{i8 %val_out}, i64 0, metadata !2900), !dbg !2903 ; [debug line = 145:31@85:4] [debug variable = tmp]
  store i8 %val_out, i8* %tmp.3, align 1, !dbg !2903 ; [debug line = 145:31@85:4]
  call void @_ssdm_op_IfWrite.Stream.i8P.i8P(i8* %out_stream.V, i8* %tmp.3) nounwind, !dbg !2904 ; [debug line = 146:9@85:4]
  %tmp. = zext i9 %x.assign to i64, !dbg !2905    ; [#uses=2 type=i64] [debug line = 88:4]
  %"line_buf[0].addr.3" = getelementptr [256 x i8]* %"line_buf[0]", i64 0, i64 %tmp. ; [#uses=2 type=i8*]
  %"right[0]" = load i8* %"line_buf[0].addr.3", align 1, !dbg !2905 ; [#uses=1 type=i8] [debug line = 88:4]
  call void @llvm.dbg.value(metadata !{i8 %"right[0]"}, i64 0, metadata !2906), !dbg !2905 ; [debug line = 88:4] [debug variable = right[0]]
  %"line_buf[1].addr.3" = getelementptr [256 x i8]* %"line_buf[1]", i64 0, i64 %tmp. ; [#uses=2 type=i8*]
  %"right[1]" = load i8* %"line_buf[1].addr.3", align 1, !dbg !2911 ; [#uses=2 type=i8] [debug line = 89:4]
  store i8 %"right[1]", i8* %"line_buf[0].addr.3", align 1, !dbg !2911 ; [debug line = 89:4]
  call void @llvm.dbg.value(metadata !{i8 %"right[1]"}, i64 0, metadata !2912), !dbg !2911 ; [debug line = 89:4] [debug variable = right[1]]
  %tmp.6 = icmp slt i32 %read_count.1, 65536, !dbg !2913 ; [#uses=1 type=i1] [debug line = 92:4]
  br i1 %tmp.6, label %.preheader.preheader, label %.loopexit, !dbg !2913 ; [debug line = 92:4]

.preheader.preheader:                             ; preds = %.preheader.preheader.i.0_ifconv
  call void @llvm.dbg.value(metadata !{i8* %in_stream.V}, i64 0, metadata !2832), !dbg !2914 ; [debug line = 129:56@95:14] [debug variable = stream<unsigned char>.V]
  call void @llvm.dbg.declare(metadata !{i8* %tmp.10}, metadata !2838) nounwind, !dbg !2917 ; [debug line = 130:22@95:14] [debug variable = tmp]
  call void @_ssdm_op_IfRead.Stream.i8P.i8P(i8* %in_stream.V, i8* %tmp.10) nounwind, !dbg !2918 ; [debug line = 131:9@95:14]
  call void @llvm.dbg.value(metadata !{i8* %tmp.10}, i64 0, metadata !2838), !dbg !2919 ; [debug line = 132:9@95:14] [debug variable = tmp]
  call void @llvm.dbg.value(metadata !{i8* %tmp.10}, i64 0, metadata !2838), !dbg !2919 ; [debug line = 132:9@95:14] [debug variable = tmp]
  %val_in = load i8* %tmp.10, align 1, !dbg !2919 ; [#uses=2 type=i8] [debug line = 132:9@95:14]
  call void @llvm.dbg.value(metadata !{i8 %val_in}, i64 0, metadata !2920), !dbg !2915 ; [debug line = 95:14] [debug variable = val_in]
  %read_count.3 = add nsw i32 %read_count.1, 1, !dbg !2921 ; [#uses=1 type=i32] [debug line = 96:5]
  call void @llvm.dbg.value(metadata !{i32 %read_count.3}, i64 0, metadata !2922), !dbg !2921 ; [debug line = 96:5] [debug variable = read_count]
  store i8 %val_in, i8* %"line_buf[1].addr.3", align 1, !dbg !2923 ; [debug line = 98:5]
  call void @llvm.dbg.value(metadata !{i8 %"window[0][0]"}, i64 0, metadata !2924), !dbg !2925 ; [debug line = 106:7] [debug variable = window[0][0]]
  call void @llvm.dbg.value(metadata !{i8 %"window[0][1]"}, i64 0, metadata !2930), !dbg !2925 ; [debug line = 106:7] [debug variable = window[0][1]]
  call void @llvm.dbg.value(metadata !{i8 %"window[1][0]"}, i64 0, metadata !2931), !dbg !2925 ; [debug line = 106:7] [debug variable = window[1][0]]
  call void @llvm.dbg.value(metadata !{i8 %"window[1][1].1"}, i64 0, metadata !2858), !dbg !2925 ; [debug line = 106:7] [debug variable = window[1][1]]
  call void @llvm.dbg.value(metadata !{i8 %"window[2][0]"}, i64 0, metadata !2932), !dbg !2925 ; [debug line = 106:7] [debug variable = window[2][0]]
  call void @llvm.dbg.value(metadata !{i8 %"window[2][1].1"}, i64 0, metadata !2864), !dbg !2925 ; [debug line = 106:7] [debug variable = window[2][1]]
  call void @llvm.dbg.value(metadata !{i8 %"right[0]"}, i64 0, metadata !2933), !dbg !2934 ; [debug line = 113:6] [debug variable = window[0][2]]
  call void @llvm.dbg.value(metadata !{i8 %"right[1]"}, i64 0, metadata !2862), !dbg !2934 ; [debug line = 113:6] [debug variable = window[1][2]]
  call void @llvm.dbg.value(metadata !{i8 %val_in}, i64 0, metadata !2866), !dbg !2934 ; [debug line = 113:6] [debug variable = window[2][2]]
  br label %.loopexit

.loopexit:                                        ; preds = %.preheader.preheader, %.preheader.preheader.i.0_ifconv
  %window.2.2.2 = phi i8 [ %val_in, %.preheader.preheader ], [ %"window[2][1].1", %.preheader.preheader.i.0_ifconv ] ; [#uses=1 type=i8]
  %window.2.1.2 = phi i8 [ %"window[2][1].1", %.preheader.preheader ], [ %"window[2][0]", %.preheader.preheader.i.0_ifconv ] ; [#uses=1 type=i8]
  %window.2.0.2 = phi i8 [ %"window[2][0]", %.preheader.preheader ], [ %window.2.0.1, %.preheader.preheader.i.0_ifconv ] ; [#uses=1 type=i8]
  %window.1.2.2 = phi i8 [ %"right[1]", %.preheader.preheader ], [ %"window[1][1].1", %.preheader.preheader.i.0_ifconv ] ; [#uses=1 type=i8]
  %window.1.1.2 = phi i8 [ %"window[1][1].1", %.preheader.preheader ], [ %"window[1][0]", %.preheader.preheader.i.0_ifconv ] ; [#uses=1 type=i8]
  %window.1.0.2 = phi i8 [ %"window[1][0]", %.preheader.preheader ], [ %window.1.0.1, %.preheader.preheader.i.0_ifconv ] ; [#uses=1 type=i8]
  %window.0.2.2 = phi i8 [ %"right[0]", %.preheader.preheader ], [ %"window[0][1]", %.preheader.preheader.i.0_ifconv ] ; [#uses=1 type=i8]
  %window.0.1.2 = phi i8 [ %"window[0][1]", %.preheader.preheader ], [ %"window[0][0]", %.preheader.preheader.i.0_ifconv ] ; [#uses=1 type=i8]
  %window.0.0.2 = phi i8 [ %"window[0][0]", %.preheader.preheader ], [ %window.0.0.1, %.preheader.preheader.i.0_ifconv ] ; [#uses=1 type=i8]
  %read_count.2 = phi i32 [ %read_count.3, %.preheader.preheader ], [ %read_count.1, %.preheader.preheader.i.0_ifconv ] ; [#uses=1 type=i32]
  %17 = call i32 (...)* @_ssdm_op_SpecRegionEnd([12 x i8]* @.str5, i32 %tmp.9), !dbg !2937 ; [#uses=0 type=i32] [debug line = 116:3]
  call void @llvm.dbg.value(metadata !{i9 %x.assign.3}, i64 0, metadata !2938), !dbg !2939 ; [debug line = 78:42] [debug variable = j]
  br label %15, !dbg !2939                        ; [debug line = 78:42]

; <label>:18                                      ; preds = %15
  %read_count.1.lcssa = phi i32 [ %read_count.1, %15 ] ; [#uses=1 type=i32]
  %window.0.0.1.lcssa = phi i8 [ %window.0.0.1, %15 ] ; [#uses=1 type=i8]
  %"window[0][0].lcssa" = phi i8 [ %"window[0][0]", %15 ] ; [#uses=1 type=i8]
  %"window[0][1].lcssa" = phi i8 [ %"window[0][1]", %15 ] ; [#uses=1 type=i8]
  %window.1.0.1.lcssa = phi i8 [ %window.1.0.1, %15 ] ; [#uses=1 type=i8]
  %"window[1][0].lcssa" = phi i8 [ %"window[1][0]", %15 ] ; [#uses=1 type=i8]
  %"window[1][1].1.lcssa" = phi i8 [ %"window[1][1].1", %15 ] ; [#uses=1 type=i8]
  %window.2.0.1.lcssa = phi i8 [ %window.2.0.1, %15 ] ; [#uses=1 type=i8]
  %"window[2][0].lcssa" = phi i8 [ %"window[2][0]", %15 ] ; [#uses=1 type=i8]
  %"window[2][1].1.lcssa" = phi i8 [ %"window[2][1].1", %15 ] ; [#uses=1 type=i8]
  %19 = call i32 (...)* @_ssdm_op_SpecRegionEnd([12 x i8]* @.str4, i32 %tmp.8), !dbg !2940 ; [#uses=0 type=i32] [debug line = 117:2]
  call void @llvm.dbg.value(metadata !{i9 %y.assign.1}, i64 0, metadata !2941), !dbg !2942 ; [debug line = 76:41] [debug variable = i]
  br label %12, !dbg !2942                        ; [debug line = 76:41]

; <label>:20                                      ; preds = %12
  ret void, !dbg !2943                            ; [debug line = 118:1]
}
...
!869 = metadata !{i32 786478, i32 0, metadata !870, metadata !"borders_ok", metadata !"borders_ok", metadata !"_Z10borders_okii", metadata !870, i32 18, metadata !871, i1 false, i1 true, i32 0, i32 0, null, i32 256, i1 false, null, null, null, metadata !87, i32 18} ; [ DW_TAG_subprogram ]
...
!873 = metadata !{i32 786478, i32 0, metadata !870, metadata !"conv_3x3_strm", metadata !"conv_3x3_strm", metadata !"_Z13conv_3x3_strmRN3hls6streamIhEES2_", metadata !870, i32 42, metadata !874, i1 false, i1 true, i32 0, i32 0, null, i32 256, i1 false, null, null, null, metadata !87, i32 42} ; [ DW_TAG_subprogram ]
...
!2764 = metadata !{null, metadata !2765, metadata !2766, metadata !2767, metadata !2768, metadata !2769, metadata !2770}
...
!2771 = metadata !{null, metadata !2765, metadata !2766, metadata !2772, metadata !2768, metadata !2773, metadata !2770}
...
!2792 = metadata !{metadata !2793, [0 x i32]* @llvm.global_ctors.0}
!2793 = metadata !{metadata !2794}
!2794 = metadata !{i32 0, i32 31, metadata !2795}
!2795 = metadata !{metadata !2796}
!2796 = metadata !{metadata !"llvm.global_ctors.0", metadata !2797, metadata !"", i32 0, i32 31}
!2797 = metadata !{metadata !2798}
!2798 = metadata !{i32 0, i32 0, i32 1}
!2799 = metadata !{metadata !2800}
!2800 = metadata !{i32 0, i32 7, metadata !2801}
!2801 = metadata !{metadata !2802}
!2802 = metadata !{metadata !"out_stream.V", metadata !2797, metadata !"unsigned char", i32 0, i32 7}
!2803 = metadata !{metadata !2804}
!2804 = metadata !{i32 0, i32 7, metadata !2805}
!2805 = metadata !{metadata !2806}
!2806 = metadata !{metadata !"in_stream.V", metadata !2797, metadata !"unsigned char", i32 0, i32 7}
!2807 = metadata !{i32 790531, metadata !2808, metadata !"out_stream.V", null, i32 42, metadata !2809, i32 0, i32 0} ; [ DW_TAG_arg_variable_field ]
!2808 = metadata !{i32 786689, metadata !873, metadata !"out_stream", metadata !870, i32 16777258, metadata !876, i32 0, i32 0} ; [ DW_TAG_arg_variable ]
!2809 = metadata !{i32 786447, null, metadata !"", null, i32 0, i64 0, i64 0, i64 0, i32 0, metadata !2810} ; [ DW_TAG_pointer_type ]
!2810 = metadata !{i32 786438, metadata !878, metadata !"stream<unsigned char>", metadata !879, i32 79, i64 8, i64 8, i32 0, i32 0, null, metadata !2811, i32 0, null, metadata !927} ; [ DW_TAG_class_field_type ]
!2811 = metadata !{metadata !881}
!2812 = metadata !{i32 42, i32 41, metadata !873, null}
!2813 = metadata !{i32 790531, metadata !2814, metadata !"in_stream.V", null, i32 42, metadata !2809, i32 0, i32 0} ; [ DW_TAG_arg_variable_field ]
!2814 = metadata !{i32 786689, metadata !873, metadata !"in_stream", metadata !870, i32 33554474, metadata !876, i32 0, i32 0} ; [ DW_TAG_arg_variable ]
!2815 = metadata !{i32 42, i32 74, metadata !873, null}
!2816 = metadata !{i32 790529, metadata !2817, metadata !"line_buf[0]", null, i32 45, metadata !2822, i32 0, i32 0} ; [ DW_TAG_auto_variable_field ]
!2817 = metadata !{i32 786688, metadata !2818, metadata !"line_buf", metadata !870, i32 45, metadata !2819, i32 0, i32 0} ; [ DW_TAG_auto_variable ]
!2818 = metadata !{i32 786443, metadata !873, i32 42, i32 84, metadata !870, i32 1} ; [ DW_TAG_lexical_block ]
!2819 = metadata !{i32 786433, null, metadata !"", null, i32 0, i64 4096, i64 8, i32 0, i32 0, metadata !935, metadata !2820, i32 0, i32 0} ; [ DW_TAG_array_type ]
!2820 = metadata !{metadata !2821, metadata !1169}
!2821 = metadata !{i32 786465, i64 0, i64 1}      ; [ DW_TAG_subrange_type ]
!2822 = metadata !{i32 786433, null, metadata !"", null, i32 0, i64 2048, i64 8, i32 0, i32 0, metadata !935, metadata !2820, i32 0, i32 0} ; [ DW_TAG_array_type ]
!2823 = metadata !{i32 45, i32 9, metadata !2818, null}
!2824 = metadata !{i32 790529, metadata !2817, metadata !"line_buf[1]", null, i32 45, metadata !2822, i32 0, i32 0} ; [ DW_TAG_auto_variable_field ]
!2825 = metadata !{i32 57, i32 39, metadata !2826, null}
!2826 = metadata !{i32 786443, metadata !2818, i32 57, i32 19, metadata !870, i32 2} ; [ DW_TAG_lexical_block ]
!2827 = metadata !{i32 62, i32 33, metadata !2828, null}
!2828 = metadata !{i32 786443, metadata !2818, i32 62, i32 19, metadata !870, i32 4} ; [ DW_TAG_lexical_block ]
!2829 = metadata !{i32 57, i32 55, metadata !2830, null}
!2830 = metadata !{i32 786443, metadata !2826, i32 57, i32 54, metadata !870, i32 3} ; [ DW_TAG_lexical_block ]
!2831 = metadata !{i32 58, i32 1, metadata !2830, null}
!2832 = metadata !{i32 790531, metadata !2833, metadata !"stream<unsigned char>.V", null, i32 129, metadata !2835, i32 0, i32 0} ; [ DW_TAG_arg_variable_field ]
!2833 = metadata !{i32 786689, metadata !944, metadata !"this", metadata !879, i32 16777345, metadata !2834, i32 64, i32 0} ; [ DW_TAG_arg_variable ]
!2834 = metadata !{i32 786447, null, metadata !"", null, i32 0, i64 64, i64 64, i64 0, i32 0, metadata !877} ; [ DW_TAG_pointer_type ]
!2835 = metadata !{i32 786447, null, metadata !"", null, i32 0, i64 64, i64 64, i64 0, i32 0, metadata !2810} ; [ DW_TAG_pointer_type ]
!2836 = metadata !{i32 129, i32 56, metadata !944, metadata !2837}
!2837 = metadata !{i32 59, i32 19, metadata !2830, null}
!2838 = metadata !{i32 786688, metadata !2839, metadata !"tmp", metadata !879, i32 130, metadata !882, i32 0, i32 0} ; [ DW_TAG_auto_variable ]
!2839 = metadata !{i32 786443, metadata !944, i32 129, i32 63, metadata !879, i32 25} ; [ DW_TAG_lexical_block ]
!2840 = metadata !{i32 130, i32 22, metadata !2839, metadata !2837}
!2841 = metadata !{i32 131, i32 9, metadata !2839, metadata !2837}
!2842 = metadata !{i32 132, i32 9, metadata !2839, metadata !2837}
!2843 = metadata !{i32 60, i32 5, metadata !2830, null}
!2844 = metadata !{i32 57, i32 50, metadata !2826, null}
!2845 = metadata !{i32 786688, metadata !2826, metadata !"x", metadata !870, i32 57, metadata !56, i32 0, i32 0} ; [ DW_TAG_auto_variable ]
!2846 = metadata !{i32 62, i32 49, metadata !2847, null}
!2847 = metadata !{i32 786443, metadata !2828, i32 62, i32 48, metadata !870, i32 5} ; [ DW_TAG_lexical_block ]
!2848 = metadata !{i32 63, i32 1, metadata !2847, null}
!2849 = metadata !{i32 129, i32 56, metadata !944, metadata !2850}
!2850 = metadata !{i32 64, i32 19, metadata !2847, null}
!2851 = metadata !{i32 130, i32 22, metadata !2839, metadata !2850}
!2852 = metadata !{i32 131, i32 9, metadata !2839, metadata !2850}
!2853 = metadata !{i32 132, i32 9, metadata !2839, metadata !2850}
!2854 = metadata !{i32 65, i32 5, metadata !2847, null}
!2855 = metadata !{i32 62, i32 44, metadata !2828, null}
!2856 = metadata !{i32 786688, metadata !2828, metadata !"x", metadata !870, i32 62, metadata !56, i32 0, i32 0} ; [ DW_TAG_auto_variable ]
!2857 = metadata !{i32 69, i32 2, metadata !2818, null}
!2858 = metadata !{i32 790529, metadata !2859, metadata !"window[1][1]", null, i32 46, metadata !2860, i32 0, i32 0} ; [ DW_TAG_auto_variable_field ]
!2859 = metadata !{i32 786688, metadata !2818, metadata !"window", metadata !870, i32 46, metadata !934, i32 0, i32 0} ; [ DW_TAG_auto_variable ]
!2860 = metadata !{i32 786433, null, metadata !"", null, i32 0, i64 8, i64 8, i32 0, i32 0, metadata !935, metadata !937, i32 0, i32 0} ; [ DW_TAG_array_type ]
!2861 = metadata !{i32 70, i32 2, metadata !2818, null}
!2862 = metadata !{i32 790529, metadata !2859, metadata !"window[1][2]", null, i32 46, metadata !2860, i32 0, i32 0} ; [ DW_TAG_auto_variable_field ]
!2863 = metadata !{i32 71, i32 2, metadata !2818, null}
!2864 = metadata !{i32 790529, metadata !2859, metadata !"window[2][1]", null, i32 46, metadata !2860, i32 0, i32 0} ; [ DW_TAG_auto_variable_field ]
!2865 = metadata !{i32 72, i32 2, metadata !2818, null}
!2866 = metadata !{i32 790529, metadata !2859, metadata !"window[2][2]", null, i32 46, metadata !2860, i32 0, i32 0} ; [ DW_TAG_auto_variable_field ]
!2867 = metadata !{i32 76, i32 30, metadata !2868, null}
!2868 = metadata !{i32 786443, metadata !2818, i32 76, i32 16, metadata !870, i32 6} ; [ DW_TAG_lexical_block ]
!2869 = metadata !{i32 77, i32 3, metadata !2870, null}
!2870 = metadata !{i32 786443, metadata !2868, i32 77, i32 2, metadata !870, i32 7} ; [ DW_TAG_lexical_block ]
!2871 = metadata !{i32 19, i32 2, metadata !2872, metadata !2873}
!2872 = metadata !{i32 786443, metadata !869, i32 18, i32 30, metadata !870, i32 0} ; [ DW_TAG_lexical_block ]
!2873 = metadata !{i32 30, i32 9, metadata !2874, metadata !2879}
!2874 = metadata !{i32 786443, metadata !2875, i32 29, i32 32, metadata !870, i32 22} ; [ DW_TAG_lexical_block ]
!2875 = metadata !{i32 786443, metadata !2876, i32 29, i32 4, metadata !870, i32 21} ; [ DW_TAG_lexical_block ]
!2876 = metadata !{i32 786443, metadata !2877, i32 28, i32 30, metadata !870, i32 20} ; [ DW_TAG_lexical_block ]
!2877 = metadata !{i32 786443, metadata !2878, i32 28, i32 2, metadata !870, i32 19} ; [ DW_TAG_lexical_block ]
!2878 = metadata !{i32 786443, metadata !930, i32 24, i32 94, metadata !870, i32 18} ; [ DW_TAG_lexical_block ]
!2879 = metadata !{i32 83, i32 24, metadata !2880, null}
!2880 = metadata !{i32 786443, metadata !2881, i32 79, i32 3, metadata !870, i32 9} ; [ DW_TAG_lexical_block ]
!2881 = metadata !{i32 786443, metadata !2870, i32 78, i32 17, metadata !870, i32 8} ; [ DW_TAG_lexical_block ]
!2882 = metadata !{i32 78, i32 31, metadata !2881, null}
!2883 = metadata !{i32 79, i32 4, metadata !2880, null}
!2884 = metadata !{i32 80, i32 1, metadata !2880, null}
!2885 = metadata !{i32 786689, metadata !930, metadata !"y", metadata !870, i32 33554456, metadata !56, i32 0, metadata !2879} ; [ DW_TAG_arg_variable ]
!2886 = metadata !{i32 24, i32 57, metadata !930, metadata !2879}
!2887 = metadata !{i32 786689, metadata !930, metadata !"x", metadata !870, i32 50331672, metadata !56, i32 0, metadata !2879} ; [ DW_TAG_arg_variable ]
!2888 = metadata !{i32 24, i32 64, metadata !930, metadata !2879}
!2889 = metadata !{i32 786689, metadata !869, metadata !"y", metadata !870, i32 16777234, metadata !56, i32 0, metadata !2873} ; [ DW_TAG_arg_variable ]
!2890 = metadata !{i32 18, i32 21, metadata !869, metadata !2873}
!2891 = metadata !{i32 786689, metadata !869, metadata !"x", metadata !870, i32 33554450, metadata !56, i32 0, metadata !2873} ; [ DW_TAG_arg_variable ]
!2892 = metadata !{i32 18, i32 28, metadata !869, metadata !2873}
!2893 = metadata !{i32 31, i32 6, metadata !2894, metadata !2879}
!2894 = metadata !{i32 786443, metadata !2874, i32 30, i32 45, metadata !870, i32 23} ; [ DW_TAG_lexical_block ]
!2895 = metadata !{i32 786688, metadata !2818, metadata !"val_out", metadata !870, i32 48, metadata !935, i32 0, i32 0} ; [ DW_TAG_auto_variable ]
!2896 = metadata !{i32 790531, metadata !2897, metadata !"stream<unsigned char>.V", null, i32 144, metadata !2835, i32 0, i32 0} ; [ DW_TAG_arg_variable_field ]
!2897 = metadata !{i32 786689, metadata !929, metadata !"this", metadata !879, i32 16777360, metadata !2834, i32 64, i32 0} ; [ DW_TAG_arg_variable ]
!2898 = metadata !{i32 144, i32 48, metadata !929, metadata !2899}
!2899 = metadata !{i32 85, i32 4, metadata !2880, null}
!2900 = metadata !{i32 786688, metadata !2901, metadata !"tmp", metadata !879, i32 145, metadata !882, i32 0, i32 0} ; [ DW_TAG_auto_variable ]
!2901 = metadata !{i32 786443, metadata !929, i32 144, i32 79, metadata !879, i32 17} ; [ DW_TAG_lexical_block ]
!2902 = metadata !{i32 145, i32 22, metadata !2901, metadata !2899}
!2903 = metadata !{i32 145, i32 31, metadata !2901, metadata !2899}
!2904 = metadata !{i32 146, i32 9, metadata !2901, metadata !2899}
!2905 = metadata !{i32 88, i32 4, metadata !2880, null}
!2906 = metadata !{i32 790529, metadata !2907, metadata !"right[0]", null, i32 47, metadata !2910, i32 0, i32 0} ; [ DW_TAG_auto_variable_field ]
!2907 = metadata !{i32 786688, metadata !2818, metadata !"right", metadata !870, i32 47, metadata !2908, i32 0, i32 0} ; [ DW_TAG_auto_variable ]
!2908 = metadata !{i32 786433, null, metadata !"", null, i32 0, i64 24, i64 8, i32 0, i32 0, metadata !935, metadata !2909, i32 0, i32 0} ; [ DW_TAG_array_type ]
!2909 = metadata !{metadata !938}
!2910 = metadata !{i32 786433, null, metadata !"", null, i32 0, i64 8, i64 8, i32 0, i32 0, metadata !935, metadata !2909, i32 0, i32 0} ; [ DW_TAG_array_type ]
!2911 = metadata !{i32 89, i32 4, metadata !2880, null}
!2912 = metadata !{i32 790529, metadata !2907, metadata !"right[1]", null, i32 47, metadata !2910, i32 0, i32 0} ; [ DW_TAG_auto_variable_field ]
!2913 = metadata !{i32 92, i32 4, metadata !2880, null}
!2914 = metadata !{i32 129, i32 56, metadata !944, metadata !2915}
!2915 = metadata !{i32 95, i32 14, metadata !2916, null}
!2916 = metadata !{i32 786443, metadata !2880, i32 93, i32 4, metadata !870, i32 10} ; [ DW_TAG_lexical_block ]
!2917 = metadata !{i32 130, i32 22, metadata !2839, metadata !2915}
!2918 = metadata !{i32 131, i32 9, metadata !2839, metadata !2915}
!2919 = metadata !{i32 132, i32 9, metadata !2839, metadata !2915}
!2920 = metadata !{i32 786688, metadata !2818, metadata !"val_in", metadata !870, i32 49, metadata !935, i32 0, i32 0} ; [ DW_TAG_auto_variable ]
!2921 = metadata !{i32 96, i32 5, metadata !2916, null}
!2922 = metadata !{i32 786688, metadata !2818, metadata !"read_count", metadata !870, i32 66, metadata !56, i32 0, i32 0} ; [ DW_TAG_auto_variable ]
!2923 = metadata !{i32 98, i32 5, metadata !2916, null}
!2924 = metadata !{i32 790529, metadata !2859, metadata !"window[0][0]", null, i32 46, metadata !2860, i32 0, i32 0} ; [ DW_TAG_auto_variable_field ]
!2925 = metadata !{i32 106, i32 7, metadata !2926, null}
!2926 = metadata !{i32 786443, metadata !2927, i32 103, i32 42, metadata !870, i32 14} ; [ DW_TAG_lexical_block ]
!2927 = metadata !{i32 786443, metadata !2928, i32 103, i32 15, metadata !870, i32 13} ; [ DW_TAG_lexical_block ]
!2928 = metadata !{i32 786443, metadata !2929, i32 102, i32 41, metadata !870, i32 12} ; [ DW_TAG_lexical_block ]
!2929 = metadata !{i32 786443, metadata !2916, i32 102, i32 14, metadata !870, i32 11} ; [ DW_TAG_lexical_block ]
!2930 = metadata !{i32 790529, metadata !2859, metadata !"window[0][1]", null, i32 46, metadata !2860, i32 0, i32 0} ; [ DW_TAG_auto_variable_field ]
!2931 = metadata !{i32 790529, metadata !2859, metadata !"window[1][0]", null, i32 46, metadata !2860, i32 0, i32 0} ; [ DW_TAG_auto_variable_field ]
!2932 = metadata !{i32 790529, metadata !2859, metadata !"window[2][0]", null, i32 46, metadata !2860, i32 0, i32 0} ; [ DW_TAG_auto_variable_field ]
!2933 = metadata !{i32 790529, metadata !2859, metadata !"window[0][2]", null, i32 46, metadata !2860, i32 0, i32 0} ; [ DW_TAG_auto_variable_field ]
!2934 = metadata !{i32 113, i32 6, metadata !2935, null}
!2935 = metadata !{i32 786443, metadata !2936, i32 110, i32 41, metadata !870, i32 16} ; [ DW_TAG_lexical_block ]
!2936 = metadata !{i32 786443, metadata !2916, i32 110, i32 14, metadata !870, i32 15} ; [ DW_TAG_lexical_block ]
!2937 = metadata !{i32 116, i32 3, metadata !2880, null}
!2938 = metadata !{i32 786688, metadata !2881, metadata !"j", metadata !870, i32 78, metadata !56, i32 0, i32 0} ; [ DW_TAG_auto_variable ]
!2939 = metadata !{i32 78, i32 42, metadata !2881, null}
!2940 = metadata !{i32 117, i32 2, metadata !2870, null}
!2941 = metadata !{i32 786688, metadata !2868, metadata !"i", metadata !870, i32 76, metadata !56, i32 0, i32 0} ; [ DW_TAG_auto_variable ]
!2942 = metadata !{i32 76, i32 41, metadata !2868, null}
!2943 = metadata !{i32 118, i32 1, metadata !2818, null}
