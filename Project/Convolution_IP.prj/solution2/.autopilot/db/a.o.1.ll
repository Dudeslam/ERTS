; ModuleID = 'C:/Users/Kristoffer/Documents/Embedded_Real_Time_Exercises/Project/Convolution_IP.prj/solution2/.autopilot/db/a.g.1.bc'
...
define void @conv_3x3_strm(%"class.hls::stream.0"* %out_stream, %"class.hls::stream.0"* %in_stream) nounwind uwtable {
  ...
  %tmp.8 = alloca i8, align 1                     ; [#uses=2 type=i8*]
  %tmp.3 = alloca i8, align 1                     ; [#uses=2 type=i8*]
  %tmp = alloca i8, align 1                       ; [#uses=2 type=i8*]
  %line_buf = alloca [2 x [256 x i8]], align 16   ; [#uses=9 type=[2 x [256 x i8]]*]
...
; <label>:1                                       ; preds = %0
  ...
  %in_stream.addr = getelementptr inbounds %"class.hls::stream.0"* %in_stream, i64 0, i32 0, !dbg !2811 ; [#uses=3 type=i8*] [debug line = 131:9@59:19]
  br label %2, !dbg !2816                         ; [debug line = 57:39]

; <label>:2                                       ; preds = %3, %1
  %x = phi i32 [ 254, %1 ], [ %x.1, %3 ]          ; [#uses=3 type=i32]
  %exitcond1 = icmp eq i32 %x, 256, !dbg !2816    ; [#uses=1 type=i1] [debug line = 57:39]
  br i1 %exitcond1, label %.preheader14.preheader, label %3, !dbg !2816 ; [debug line = 57:39]

.preheader14.preheader:                           ; preds = %2
  br label %.preheader14, !dbg !2817              ; [debug line = 62:33]

; <label>:3                                       ; preds = %2
  call void (...)* @_ssdm_op_SpecLoopName(i8* getelementptr inbounds ([15 x i8]* @.str2, i64 0, i64 0)) nounwind, !dbg !2819 ; [debug line = 57:55]
  %rbegin1 = call i32 (...)* @_ssdm_op_SpecRegionBegin(i8* getelementptr inbounds ([15 x i8]* @.str2, i64 0, i64 0)) nounwind, !dbg !2819 ; [#uses=1 type=i32] [debug line = 57:55]
  call void (...)* @_ssdm_op_SpecPipeline(i32 -1, i32 1, i32 1, i32 0, i8* getelementptr inbounds ([1 x i8]* @.str1, i64 0, i64 0)) nounwind, !dbg !2820 ; [debug line = 58:1]
  call void @llvm.dbg.value(metadata !{%"class.hls::stream.0"* %in_stream}, i64 0, metadata !2821), !dbg !2823 ; [debug line = 129:56@59:19] [debug variable = this]
  call void @llvm.dbg.declare(metadata !{i8* %tmp}, metadata !2824) nounwind, !dbg !2825 ; [debug line = 130:22@59:19] [debug variable = tmp]
  call void @_ssdm_op_IfRead.Stream.i8P.i8P(i8* %in_stream.addr, i8* %tmp) nounwind, !dbg !2811 ; [debug line = 131:9@59:19]
  call void @llvm.dbg.value(metadata !{i8* %tmp}, i64 0, metadata !2824), !dbg !2826 ; [debug line = 132:9@59:19] [debug variable = tmp]
  call void @llvm.dbg.value(metadata !{i8* %tmp}, i64 0, metadata !2824), !dbg !2826 ; [debug line = 132:9@59:19] [debug variable = tmp]
  call void @llvm.dbg.value(metadata !{i8* %tmp}, i64 0, metadata !2824), !dbg !2826 ; [debug line = 132:9@59:19] [debug variable = tmp]
  call void @llvm.dbg.value(metadata !{i8* %tmp}, i64 0, metadata !2824), !dbg !2826 ; [debug line = 132:9@59:19] [debug variable = tmp]
  call void @llvm.dbg.value(metadata !{i8* %tmp}, i64 0, metadata !2824), !dbg !2826 ; [debug line = 132:9@59:19] [debug variable = tmp]
  ...
  call void @llvm.dbg.value(metadata !{i8* %tmp}, i64 0, metadata !2824), !dbg !2826 ; [debug line = 132:9@59:19] [debug variable = tmp]
  call void @llvm.dbg.value(metadata !{i8* %tmp}, i64 0, metadata !2824), !dbg !2826 ; [debug line = 132:9@59:19] [debug variable = tmp]
  %4 = load i8* %tmp, align 1, !dbg !2826         ; [#uses=1 type=i8] [debug line = 132:9@59:19]
  %tmp.1 = sext i32 %x to i64, !dbg !2813         ; [#uses=1 type=i64] [debug line = 59:19]
  %line_buf.addr.1 = getelementptr inbounds [2 x [256 x i8]]* %line_buf, i64 0, i64 0, i64 %tmp.1, !dbg !2813 ; [#uses=1 type=i8*] [debug line = 59:19]
  store i8 %4, i8* %line_buf.addr.1, align 1, !dbg !2813 ; [debug line = 59:19]
  %rend22 = call i32 (...)* @_ssdm_op_SpecRegionEnd(i8* getelementptr inbounds ([15 x i8]* @.str2, i64 0, i64 0), i32 %rbegin1) nounwind, !dbg !2827 ; [#uses=0 type=i32] [debug line = 60:5]
  %x.1 = add nsw i32 %x, 1, !dbg !2828            ; [#uses=1 type=i32] [debug line = 57:50]
  call void @llvm.dbg.value(metadata !{i32 %x.1}, i64 0, metadata !2829), !dbg !2828 ; [debug line = 57:50] [debug variable = x]
  br label %2, !dbg !2828                         ; [debug line = 57:50]

.preheader14:                                     ; preds = %5, %.preheader14.preheader
  %x1 = phi i32 [ %x.2, %5 ], [ 0, %.preheader14.preheader ] ; [#uses=3 type=i32]
  %exitcond2 = icmp eq i32 %x1, 256, !dbg !2817   ; [#uses=1 type=i1] [debug line = 62:33]
  br i1 %exitcond2, label %6, label %5, !dbg !2817 ; [debug line = 62:33]

; <label>:5                                       ; preds = %.preheader14
  call void (...)* @_ssdm_op_SpecLoopName(i8* getelementptr inbounds ([15 x i8]* @.str3, i64 0, i64 0)) nounwind, !dbg !2830 ; [debug line = 62:49]
  %rbegin2 = call i32 (...)* @_ssdm_op_SpecRegionBegin(i8* getelementptr inbounds ([15 x i8]* @.str3, i64 0, i64 0)) nounwind, !dbg !2830 ; [#uses=1 type=i32] [debug line = 62:49]
  call void (...)* @_ssdm_op_SpecPipeline(i32 -1, i32 1, i32 1, i32 0, i8* getelementptr inbounds ([1 x i8]* @.str1, i64 0, i64 0)) nounwind, !dbg !2832 ; [debug line = 63:1]
  call void @llvm.dbg.value(metadata !{%"class.hls::stream.0"* %in_stream}, i64 0, metadata !2821), !dbg !2833 ; [debug line = 129:56@64:19] [debug variable = this]
  call void @llvm.dbg.declare(metadata !{i8* %tmp.3}, metadata !2824) nounwind, !dbg !2835 ; [debug line = 130:22@64:19] [debug variable = tmp]
  call void @_ssdm_op_IfRead.Stream.i8P.i8P(i8* %in_stream.addr, i8* %tmp.3) nounwind, !dbg !2836 ; [debug line = 131:9@64:19]
  call void @llvm.dbg.value(metadata !{i8* %tmp.3}, i64 0, metadata !2824), !dbg !2837 ; [debug line = 132:9@64:19] [debug variable = tmp]
  call void @llvm.dbg.value(metadata !{i8* %tmp.3}, i64 0, metadata !2824), !dbg !2837 ; [debug line = 132:9@64:19] [debug variable = tmp]
  call void @llvm.dbg.value(metadata !{i8* %tmp.3}, i64 0, metadata !2824), !dbg !2837 ; [debug line = 132:9@64:19] [debug variable = tmp]
  call void @llvm.dbg.value(metadata !{i8* %tmp.3}, i64 0, metadata !2824), !dbg !2837 ; [debug line = 132:9@64:19] [debug variable = tmp]
  call void @llvm.dbg.value(metadata !{i8* %tmp.3}, i64 0, metadata !2824), !dbg !2837 ; [debug line = 132:9@64:19] [debug variable = tmp]
  ...
  call void @llvm.dbg.value(metadata !{i8* %tmp.3}, i64 0, metadata !2824), !dbg !2837 ; [debug line = 132:9@64:19] [debug variable = tmp]
  call void @llvm.dbg.value(metadata !{i8* %tmp.3}, i64 0, metadata !2824), !dbg !2837 ; [debug line = 132:9@64:19] [debug variable = tmp]
  %tmp.3.load = load i8* %tmp.3, align 1, !dbg !2837 ; [#uses=1 type=i8] [debug line = 132:9@64:19]
  %tmp.4 = sext i32 %x1 to i64, !dbg !2834        ; [#uses=1 type=i64] [debug line = 64:19]
  %line_buf.addr.6 = getelementptr inbounds [2 x [256 x i8]]* %line_buf, i64 0, i64 1, i64 %tmp.4, !dbg !2834 ; [#uses=1 type=i8*] [debug line = 64:19]
  store i8 %tmp.3.load, i8* %line_buf.addr.6, align 1, !dbg !2834 ; [debug line = 64:19]
  %rend24 = call i32 (...)* @_ssdm_op_SpecRegionEnd(i8* getelementptr inbounds ([15 x i8]* @.str3, i64 0, i64 0), i32 %rbegin2) nounwind, !dbg !2838 ; [#uses=0 type=i32] [debug line = 65:5]
  %x.2 = add nsw i32 %x1, 1, !dbg !2839           ; [#uses=1 type=i32] [debug line = 62:44]
  call void @llvm.dbg.value(metadata !{i32 %x.2}, i64 0, metadata !2840), !dbg !2839 ; [debug line = 62:44] [debug variable = x]
  br label %.preheader14, !dbg !2839              ; [debug line = 62:44]

; <label>:6                                       ; preds = %.preheader14
  %line_buf.addr.2 = getelementptr inbounds [2 x [256 x i8]]* %line_buf, i64 0, i64 0, i64 254, !dbg !2841 ; [#uses=1 type=i8*] [debug line = 69:2]
  %line_buf.load = load i8* %line_buf.addr.2, align 2, !dbg !2841 ; [#uses=2 type=i8] [debug line = 69:2]
  call void (...)* @_ssdm_SpecKeepArrayLoad(i8 %line_buf.load) nounwind
  %window.addr.1 = getelementptr inbounds [3 x [3 x i8]]* %window, i64 0, i64 1, i64 1, !dbg !2841 ; [#uses=1 type=i8*] [debug line = 69:2]
  store i8 %line_buf.load, i8* %window.addr.1, align 1, !dbg !2841 ; [debug line = 69:2]
  %line_buf.addr.3 = getelementptr inbounds [2 x [256 x i8]]* %line_buf, i64 0, i64 0, i64 255, !dbg !2842 ; [#uses=1 type=i8*] [debug line = 70:2]
  %line_buf.load.1 = load i8* %line_buf.addr.3, align 1, !dbg !2842 ; [#uses=2 type=i8] [debug line = 70:2]
  call void (...)* @_ssdm_SpecKeepArrayLoad(i8 %line_buf.load.1) nounwind
  %window.addr.2 = getelementptr inbounds [3 x [3 x i8]]* %window, i64 0, i64 1, i64 2, !dbg !2842 ; [#uses=1 type=i8*] [debug line = 70:2]
  store i8 %line_buf.load.1, i8* %window.addr.2, align 1, !dbg !2842 ; [debug line = 70:2]
  %line_buf.addr.4 = getelementptr inbounds [2 x [256 x i8]]* %line_buf, i64 0, i64 1, i64 254, !dbg !2843 ; [#uses=1 type=i8*] [debug line = 71:2]
  %line_buf.load.2 = load i8* %line_buf.addr.4, align 2, !dbg !2843 ; [#uses=2 type=i8] [debug line = 71:2]
  call void (...)* @_ssdm_SpecKeepArrayLoad(i8 %line_buf.load.2) nounwind
  %window.addr.3 = getelementptr inbounds [3 x [3 x i8]]* %window, i64 0, i64 2, i64 1, !dbg !2843 ; [#uses=1 type=i8*] [debug line = 71:2]
  store i8 %line_buf.load.2, i8* %window.addr.3, align 1, !dbg !2843 ; [debug line = 71:2]
  %line_buf.addr.5 = getelementptr inbounds [2 x [256 x i8]]* %line_buf, i64 0, i64 1, i64 255, !dbg !2844 ; [#uses=1 type=i8*] [debug line = 72:2]
  %line_buf.load.3 = load i8* %line_buf.addr.5, align 1, !dbg !2844 ; [#uses=2 type=i8] [debug line = 72:2]
  call void (...)* @_ssdm_SpecKeepArrayLoad(i8 %line_buf.load.3) nounwind
  %window.addr.4 = getelementptr inbounds [3 x [3 x i8]]* %window, i64 0, i64 2, i64 2, !dbg !2844 ; [#uses=1 type=i8*] [debug line = 72:2]
  store i8 %line_buf.load.3, i8* %window.addr.4, align 1, !dbg !2844 ; [debug line = 72:2]
  %out_stream.addr = getelementptr inbounds %"class.hls::stream.0"* %out_stream, i64 0, i32 0, !dbg !2845 ; [#uses=1 type=i8*] [debug line = 146:9@85:4]
  %right.addr.1 = getelementptr inbounds [3 x i8]* %right, i64 0, i64 1, !dbg !2852 ; [#uses=1 type=i8*] [debug line = 89:4]
  %right.addr.2 = getelementptr inbounds [3 x i8]* %right, i64 0, i64 2, !dbg !2853 ; [#uses=1 type=i8*] [debug line = 98:5]
  br label %7, !dbg !2855                         ; [debug line = 76:30]

; <label>:7                                       ; preds = %22, %6
  %read_count = phi i32 [ 258, %6 ], [ %read_count.1.lcssa, %22 ] ; [#uses=1 type=i32]
  %y.assign = phi i32 [ 0, %6 ], [ %i.1, %22 ]    ; [#uses=3 type=i32]
  %exitcond3 = icmp eq i32 %y.assign, 256, !dbg !2855 ; [#uses=1 type=i1] [debug line = 76:30]
  br i1 %exitcond3, label %23, label %8, !dbg !2855 ; [debug line = 76:30]

; <label>:8                                       ; preds = %7
  call void (...)* @_ssdm_op_SpecLoopName(i8* getelementptr inbounds ([12 x i8]* @.str4, i64 0, i64 0)) nounwind, !dbg !2856 ; [debug line = 77:3]
  %rbegin = call i32 (...)* @_ssdm_op_SpecRegionBegin(i8* getelementptr inbounds ([12 x i8]* @.str4, i64 0, i64 0)) nounwind, !dbg !2856 ; [#uses=1 type=i32] [debug line = 77:3]
  br label %9, !dbg !2857                         ; [debug line = 78:31]
...
; <label>:9                                       ; preds = %.loopexit, %8
  ...
  %exitcond4 = icmp eq i32 %x.assign, 256, !dbg !2857 ; [#uses=1 type=i1] [debug line = 78:31]
  br i1 %exitcond4, label %22, label %10, !dbg !2857 ; [debug line = 78:31]

; <label>:10                                      ; preds = %9
  call void (...)* @_ssdm_op_SpecLoopName(i8* getelementptr inbounds ([12 x i8]* @.str5, i64 0, i64 0)) nounwind, !dbg !2858 ; [debug line = 79:4]
  %rbegin3 = call i32 (...)* @_ssdm_op_SpecRegionBegin(i8* getelementptr inbounds ([12 x i8]* @.str5, i64 0, i64 0)) nounwind, !dbg !2858 ; [#uses=1 type=i32] [debug line = 79:4]
  call void (...)* @_ssdm_op_SpecPipeline(i32 -1, i32 1, i32 1, i32 0, i8* getelementptr inbounds ([1 x i8]* @.str1, i64 0, i64 0)) nounwind, !dbg !2859 ; [debug line = 80:1]
  call void @llvm.dbg.value(metadata !{[3 x [3 x i8]]* %window}, i64 0, metadata !2860) nounwind, !dbg !2862 ; [debug line = 24:31@83:24] [debug variable = window]
  call void @llvm.dbg.value(metadata !{i32 %y.assign}, i64 0, metadata !2863) nounwind, !dbg !2864 ; [debug line = 24:57@83:24] [debug variable = y]
  call void @llvm.dbg.value(metadata !{i32 %x.assign}, i64 0, metadata !2865) nounwind, !dbg !2866 ; [debug line = 24:64@83:24] [debug variable = x]
  br label %11, !dbg !2867                        ; [debug line = 28:16@83:24]
...
; <label>:11                                      ; preds = %14, %10
  ...
  %exitcond1.i = icmp eq i32 %i.0.i, 3, !dbg !2867 ; [#uses=1 type=i1] [debug line = 28:16@83:24]
  br i1 %exitcond1.i, label %"convolution_step<3, 3>.exit", label %.preheader.preheader.i, !dbg !2867 ; [debug line = 28:16@83:24]

.preheader.preheader.i:                           ; preds = %11
  %tmp.12 = add nsw i32 %i.0.i, %y.assign, !dbg !2870 ; [#uses=1 type=i32] [debug line = 30:9@83:24]
  %tmp.13 = sext i32 %i.0.i to i64, !dbg !2874    ; [#uses=2 type=i64] [debug line = 31:6@83:24]
  br label %.preheader.i, !dbg !2876              ; [debug line = 29:18@83:24]
...
.preheader.i:                                     ; preds = %._crit_edge.i, %.preheader.preheader.i
  ...
  %exitcond.i = icmp eq i32 %j.0.i, 3, !dbg !2876 ; [#uses=1 type=i1] [debug line = 29:18@83:24]
  br i1 %exitcond.i, label %14, label %12, !dbg !2876 ; [debug line = 29:18@83:24]

; <label>:12                                      ; preds = %.preheader.i
  %tmp.17 = add nsw i32 %j.0.i, %x.assign, !dbg !2870 ; [#uses=1 type=i32] [debug line = 30:9@83:24]
  %tmp.18 = call fastcc zeroext i1 @borders_ok(i32 %tmp.12, i32 %tmp.17) nounwind, !dbg !2870 ; [#uses=1 type=i1] [debug line = 30:9@83:24]
  %brmerge.demorgan.i = and i1 %tmp.18, %border.1.i, !dbg !2870 ; [#uses=1 type=i1] [debug line = 30:9@83:24]
  br i1 %brmerge.demorgan.i, label %13, label %._crit_edge.i, !dbg !2870 ; [debug line = 30:9@83:24]

; <label>:13                                      ; preds = %12
  %tmp.20 = sext i32 %j.0.i to i64, !dbg !2874    ; [#uses=2 type=i64] [debug line = 31:6@83:24]
  %window.assign.addr = getelementptr inbounds [3 x [3 x i8]]* %window, i64 0, i64 %tmp.13, i64 %tmp.20, !dbg !2874 ; [#uses=1 type=i8*] [debug line = 31:6@83:24]
  %window.assign.load = load i8* %window.assign.addr, align 1, !dbg !2874 ; [#uses=2 type=i8] [debug line = 31:6@83:24]
  call void (...)* @_ssdm_SpecKeepArrayLoad(i8 %window.assign.load) nounwind
  %tmp.21 = zext i8 %window.assign.load to i32, !dbg !2874 ; [#uses=1 type=i32] [debug line = 31:6@83:24]
  %kernel.addr = getelementptr inbounds [3 x [3 x i32]]* @kernel, i64 0, i64 %tmp.13, i64 %tmp.20, !dbg !2874 ; [#uses=1 type=i32*] [debug line = 31:6@83:24]
  %kernel.load = load i32* %kernel.addr, align 4, !dbg !2874 ; [#uses=2 type=i32] [debug line = 31:6@83:24]
  call void (...)* @_ssdm_SpecKeepArrayLoad(i32 %kernel.load) nounwind
  %tmp.22 = mul nsw i32 %kernel.load, %tmp.21, !dbg !2874 ; [#uses=1 type=i32] [debug line = 31:6@83:24]
  %result = add nsw i32 %tmp.22, %result.1.i, !dbg !2874 ; [#uses=1 type=i32] [debug line = 31:6@83:24]
  call void @llvm.dbg.value(metadata !{i32 %result}, i64 0, metadata !2877) nounwind, !dbg !2874 ; [debug line = 31:6@83:24] [debug variable = result]
  br label %._crit_edge.i, !dbg !2878             ; [debug line = 32:5@83:24]
...
._crit_edge.i:                                    ; preds = %13, %12
  ...
  %j = add nsw i32 %j.0.i, 1, !dbg !2879          ; [#uses=1 type=i32] [debug line = 29:27@83:24]
  call void @llvm.dbg.value(metadata !{i32 %j}, i64 0, metadata !2880) nounwind, !dbg !2879 ; [debug line = 29:27@83:24] [debug variable = j]
  br label %.preheader.i, !dbg !2879              ; [debug line = 29:27@83:24]
...
; <label>:14                                      ; preds = %.preheader.i
  ...
  %i = add nsw i32 %i.0.i, 1, !dbg !2881          ; [#uses=1 type=i32] [debug line = 28:25@83:24]
  call void @llvm.dbg.value(metadata !{i32 %i}, i64 0, metadata !2882) nounwind, !dbg !2881 ; [debug line = 28:25@83:24] [debug variable = i]
  br label %11, !dbg !2881                        ; [debug line = 28:25@83:24]

"convolution_step<3, 3>.exit":                    ; preds = %11
  %result.0.i.lcssa = phi i32 [ %result.0.i, %11 ] ; [#uses=2 type=i32]
  %tmp.7 = sdiv i32 %result.0.i.lcssa, 4, !dbg !2861 ; [#uses=2 type=i32] [debug line = 83:24]
  %neg = sub i32 0, %tmp.7                        ; [#uses=1 type=i32]
  %abscond = icmp sgt i32 %result.0.i.lcssa, 3    ; [#uses=1 type=i1]
  %abs = select i1 %abscond, i32 %tmp.7, i32 %neg ; [#uses=1 type=i32]
  %val_out = trunc i32 %abs to i8, !dbg !2861     ; [#uses=1 type=i8] [debug line = 83:24]
  call void @llvm.dbg.value(metadata !{i8 %val_out}, i64 0, metadata !2883), !dbg !2861 ; [debug line = 83:24] [debug variable = val_out]
  call void @llvm.dbg.value(metadata !{%"class.hls::stream.0"* %out_stream}, i64 0, metadata !2884), !dbg !2885 ; [debug line = 144:48@85:4] [debug variable = this]
  call void @llvm.dbg.declare(metadata !{i8* %tmp.8}, metadata !2886) nounwind, !dbg !2887 ; [debug line = 145:22@85:4] [debug variable = tmp]
  call void @llvm.dbg.value(metadata !{i8 %val_out}, i64 0, metadata !2886), !dbg !2888 ; [debug line = 145:31@85:4] [debug variable = tmp]
  call void @llvm.dbg.value(metadata !{i8 %val_out}, i64 0, metadata !2886), !dbg !2888 ; [debug line = 145:31@85:4] [debug variable = tmp]
  call void @llvm.dbg.value(metadata !{i8 %val_out}, i64 0, metadata !2886), !dbg !2888 ; [debug line = 145:31@85:4] [debug variable = tmp]
  call void @llvm.dbg.value(metadata !{i8 %val_out}, i64 0, metadata !2886), !dbg !2888 ; [debug line = 145:31@85:4] [debug variable = tmp]
  call void @llvm.dbg.value(metadata !{i8 %val_out}, i64 0, metadata !2886), !dbg !2888 ; [debug line = 145:31@85:4] [debug variable = tmp]
  ...
  call void @llvm.dbg.value(metadata !{i8 %val_out}, i64 0, metadata !2886), !dbg !2888 ; [debug line = 145:31@85:4] [debug variable = tmp]
  call void @llvm.dbg.value(metadata !{i8 %val_out}, i64 0, metadata !2886), !dbg !2888 ; [debug line = 145:31@85:4] [debug variable = tmp]
  store i8 %val_out, i8* %tmp.8, align 1, !dbg !2888 ; [debug line = 145:31@85:4]
  call void @_ssdm_op_IfWrite.Stream.i8P.i8P(i8* %out_stream.addr, i8* %tmp.8) nounwind, !dbg !2845 ; [debug line = 146:9@85:4]
  %tmp.10 = sext i32 %x.assign to i64, !dbg !2889 ; [#uses=2 type=i64] [debug line = 88:4]
  %line_buf.addr.7 = getelementptr inbounds [2 x [256 x i8]]* %line_buf, i64 0, i64 0, i64 %tmp.10, !dbg !2889 ; [#uses=2 type=i8*] [debug line = 88:4]
  %line_buf.load.4 = load i8* %line_buf.addr.7, align 1, !dbg !2889 ; [#uses=2 type=i8] [debug line = 88:4]
  call void (...)* @_ssdm_SpecKeepArrayLoad(i8 %line_buf.load.4) nounwind
  store i8 %line_buf.load.4, i8* %right.addr, align 1, !dbg !2889 ; [debug line = 88:4]
  %line_buf.addr.8 = getelementptr inbounds [2 x [256 x i8]]* %line_buf, i64 0, i64 1, i64 %tmp.10, !dbg !2852 ; [#uses=2 type=i8*] [debug line = 89:4]
  %line_buf.load.5 = load i8* %line_buf.addr.8, align 1, !dbg !2852 ; [#uses=3 type=i8] [debug line = 89:4]
  call void (...)* @_ssdm_SpecKeepArrayLoad(i8 %line_buf.load.5) nounwind
  store i8 %line_buf.load.5, i8* %line_buf.addr.7, align 1, !dbg !2852 ; [debug line = 89:4]
  store i8 %line_buf.load.5, i8* %right.addr.1, align 1, !dbg !2852 ; [debug line = 89:4]
  %tmp.11 = icmp slt i32 %read_count.1, 65536, !dbg !2890 ; [#uses=1 type=i1] [debug line = 92:4]
  br i1 %tmp.11, label %15, label %.loopexit, !dbg !2890 ; [debug line = 92:4]

; <label>:15                                      ; preds = %"convolution_step<3, 3>.exit"
  call void @llvm.dbg.value(metadata !{%"class.hls::stream.0"* %in_stream}, i64 0, metadata !2821), !dbg !2891 ; [debug line = 129:56@95:14] [debug variable = this]
  call void @llvm.dbg.declare(metadata !{i8* %tmp.14}, metadata !2824) nounwind, !dbg !2893 ; [debug line = 130:22@95:14] [debug variable = tmp]
  call void @_ssdm_op_IfRead.Stream.i8P.i8P(i8* %in_stream.addr, i8* %tmp.14) nounwind, !dbg !2894 ; [debug line = 131:9@95:14]
  call void @llvm.dbg.value(metadata !{i8* %tmp.14}, i64 0, metadata !2824), !dbg !2895 ; [debug line = 132:9@95:14] [debug variable = tmp]
  call void @llvm.dbg.value(metadata !{i8* %tmp.14}, i64 0, metadata !2824), !dbg !2895 ; [debug line = 132:9@95:14] [debug variable = tmp]
  call void @llvm.dbg.value(metadata !{i8* %tmp.14}, i64 0, metadata !2824), !dbg !2895 ; [debug line = 132:9@95:14] [debug variable = tmp]
  call void @llvm.dbg.value(metadata !{i8* %tmp.14}, i64 0, metadata !2824), !dbg !2895 ; [debug line = 132:9@95:14] [debug variable = tmp]
  call void @llvm.dbg.value(metadata !{i8* %tmp.14}, i64 0, metadata !2824), !dbg !2895 ; [debug line = 132:9@95:14] [debug variable = tmp]
  ...
  call void @llvm.dbg.value(metadata !{i8* %tmp.14}, i64 0, metadata !2824), !dbg !2895 ; [debug line = 132:9@95:14] [debug variable = tmp]
  call void @llvm.dbg.value(metadata !{i8* %tmp.14}, i64 0, metadata !2824), !dbg !2895 ; [debug line = 132:9@95:14] [debug variable = tmp]
  %val_in = load i8* %tmp.14, align 1, !dbg !2895 ; [#uses=2 type=i8] [debug line = 132:9@95:14]
  call void @llvm.dbg.value(metadata !{i8 %val_in}, i64 0, metadata !2896), !dbg !2892 ; [debug line = 95:14] [debug variable = val_in]
  %read_count.3 = add nsw i32 %read_count.1, 1, !dbg !2897 ; [#uses=1 type=i32] [debug line = 96:5]
  call void @llvm.dbg.value(metadata !{i32 %read_count.3}, i64 0, metadata !2898), !dbg !2897 ; [debug line = 96:5] [debug variable = read_count]
  store i8 %val_in, i8* %line_buf.addr.8, align 1, !dbg !2853 ; [debug line = 98:5]
  store i8 %val_in, i8* %right.addr.2, align 1, !dbg !2853 ; [debug line = 98:5]
  br label %16, !dbg !2899                        ; [debug line = 102:28]

; <label>:16                                      ; preds = %20, %15
  %y = phi i32 [ 0, %15 ], [ %y.2, %20 ]          ; [#uses=3 type=i32]
  %exitcond9 = icmp eq i32 %y, 3, !dbg !2899      ; [#uses=1 type=i1] [debug line = 102:28]
  br i1 %exitcond9, label %.preheader.preheader, label %17, !dbg !2899 ; [debug line = 102:28]

.preheader.preheader:                             ; preds = %16
  br label %.preheader, !dbg !2901                ; [debug line = 110:28]

; <label>:17                                      ; preds = %16
  call void (...)* @_ssdm_op_SpecLoopName(i8* getelementptr inbounds ([7 x i8]* @.str6, i64 0, i64 0)) nounwind, !dbg !2903 ; [debug line = 102:42]
  %rbegin4 = call i32 (...)* @_ssdm_op_SpecRegionBegin(i8* getelementptr inbounds ([7 x i8]* @.str6, i64 0, i64 0)) nounwind, !dbg !2903 ; [#uses=1 type=i32] [debug line = 102:42]
  %tmp.19 = sext i32 %y to i64, !dbg !2905        ; [#uses=2 type=i64] [debug line = 106:7]
  br label %18, !dbg !2908                        ; [debug line = 103:29]

; <label>:18                                      ; preds = %19, %17
  %x2 = phi i32 [ 0, %17 ], [ %x.3, %19 ]         ; [#uses=3 type=i32]
  %exitcond8 = icmp eq i32 %x2, 2, !dbg !2908     ; [#uses=1 type=i1] [debug line = 103:29]
  br i1 %exitcond8, label %20, label %19, !dbg !2908 ; [debug line = 103:29]

; <label>:19                                      ; preds = %18
  call void (...)* @_ssdm_op_SpecLoopName(i8* getelementptr inbounds ([7 x i8]* @.str7, i64 0, i64 0)) nounwind, !dbg !2909 ; [debug line = 103:43]
  %rbegin6 = call i32 (...)* @_ssdm_op_SpecRegionBegin(i8* getelementptr inbounds ([7 x i8]* @.str7, i64 0, i64 0)) nounwind, !dbg !2909 ; [#uses=1 type=i32] [debug line = 103:43]
  %x.3 = add nsw i32 %x2, 1, !dbg !2905           ; [#uses=2 type=i32] [debug line = 106:7]
  %tmp.29 = sext i32 %x.3 to i64, !dbg !2905      ; [#uses=1 type=i64] [debug line = 106:7]
  %window.assign.addr.2 = getelementptr inbounds [3 x [3 x i8]]* %window, i64 0, i64 %tmp.19, i64 %tmp.29, !dbg !2905 ; [#uses=1 type=i8*] [debug line = 106:7]
  %window.assign.load.1 = load i8* %window.assign.addr.2, align 1, !dbg !2905 ; [#uses=2 type=i8] [debug line = 106:7]
  call void (...)* @_ssdm_SpecKeepArrayLoad(i8 %window.assign.load.1) nounwind
  %tmp.30 = sext i32 %x2 to i64, !dbg !2905       ; [#uses=1 type=i64] [debug line = 106:7]
  %window.assign.addr.3 = getelementptr inbounds [3 x [3 x i8]]* %window, i64 0, i64 %tmp.19, i64 %tmp.30, !dbg !2905 ; [#uses=1 type=i8*] [debug line = 106:7]
  store i8 %window.assign.load.1, i8* %window.assign.addr.3, align 1, !dbg !2905 ; [debug line = 106:7]
  %rend28 = call i32 (...)* @_ssdm_op_SpecRegionEnd(i8* getelementptr inbounds ([7 x i8]* @.str7, i64 0, i64 0), i32 %rbegin6) nounwind, !dbg !2910 ; [#uses=0 type=i32] [debug line = 107:6]
  call void @llvm.dbg.value(metadata !{i32 %x.3}, i64 0, metadata !2911), !dbg !2912 ; [debug line = 103:38] [debug variable = x]
  br label %18, !dbg !2912                        ; [debug line = 103:38]

; <label>:20                                      ; preds = %18
  %rend26 = call i32 (...)* @_ssdm_op_SpecRegionEnd(i8* getelementptr inbounds ([7 x i8]* @.str6, i64 0, i64 0), i32 %rbegin4) nounwind, !dbg !2913 ; [#uses=0 type=i32] [debug line = 108:5]
  %y.2 = add nsw i32 %y, 1, !dbg !2914            ; [#uses=1 type=i32] [debug line = 102:37]
  call void @llvm.dbg.value(metadata !{i32 %y.2}, i64 0, metadata !2915), !dbg !2914 ; [debug line = 102:37] [debug variable = y]
  br label %16, !dbg !2914                        ; [debug line = 102:37]

.preheader:                                       ; preds = %21, %.preheader.preheader
  %y3 = phi i32 [ %y.1, %21 ], [ 0, %.preheader.preheader ] ; [#uses=3 type=i32]
  %exitcond = icmp eq i32 %y3, 3, !dbg !2901      ; [#uses=1 type=i1] [debug line = 110:28]
  br i1 %exitcond, label %.loopexit.loopexit, label %21, !dbg !2901 ; [debug line = 110:28]

; <label>:21                                      ; preds = %.preheader
  call void (...)* @_ssdm_op_SpecLoopName(i8* getelementptr inbounds ([7 x i8]* @.str8, i64 0, i64 0)) nounwind, !dbg !2916 ; [debug line = 110:42]
  %rbegin5 = call i32 (...)* @_ssdm_op_SpecRegionBegin(i8* getelementptr inbounds ([7 x i8]* @.str8, i64 0, i64 0)) nounwind, !dbg !2916 ; [#uses=1 type=i32] [debug line = 110:42]
  %tmp.25 = sext i32 %y3 to i64, !dbg !2918       ; [#uses=2 type=i64] [debug line = 113:6]
  %right.addr.3 = getelementptr inbounds [3 x i8]* %right, i64 0, i64 %tmp.25, !dbg !2918 ; [#uses=1 type=i8*] [debug line = 113:6]
  %right.load = load i8* %right.addr.3, align 1, !dbg !2918 ; [#uses=2 type=i8] [debug line = 113:6]
  call void (...)* @_ssdm_SpecKeepArrayLoad(i8 %right.load) nounwind
  %window.assign.addr.1 = getelementptr inbounds [3 x [3 x i8]]* %window, i64 0, i64 %tmp.25, i64 2, !dbg !2918 ; [#uses=1 type=i8*] [debug line = 113:6]
  store i8 %right.load, i8* %window.assign.addr.1, align 1, !dbg !2918 ; [debug line = 113:6]
  %rend30 = call i32 (...)* @_ssdm_op_SpecRegionEnd(i8* getelementptr inbounds ([7 x i8]* @.str8, i64 0, i64 0), i32 %rbegin5) nounwind, !dbg !2919 ; [#uses=0 type=i32] [debug line = 114:5]
  %y.1 = add nsw i32 %y3, 1, !dbg !2920           ; [#uses=1 type=i32] [debug line = 110:37]
  call void @llvm.dbg.value(metadata !{i32 %y.1}, i64 0, metadata !2921), !dbg !2920 ; [debug line = 110:37] [debug variable = y]
  br label %.preheader, !dbg !2920                ; [debug line = 110:37]
...
.loopexit:                                        ; preds = %.loopexit.loopexit, %"convolution_step<3, 3>.exit"
  ...
  %rend20 = call i32 (...)* @_ssdm_op_SpecRegionEnd(i8* getelementptr inbounds ([12 x i8]* @.str5, i64 0, i64 0), i32 %rbegin3) nounwind, !dbg !2922 ; [#uses=0 type=i32] [debug line = 116:3]
  %j.1 = add nsw i32 %x.assign, 1, !dbg !2923     ; [#uses=1 type=i32] [debug line = 78:42]
  call void @llvm.dbg.value(metadata !{i32 %j.1}, i64 0, metadata !2924), !dbg !2923 ; [debug line = 78:42] [debug variable = j]
  br label %9, !dbg !2923                         ; [debug line = 78:42]

; <label>:22                                      ; preds = %9
  %read_count.1.lcssa = phi i32 [ %read_count.1, %9 ] ; [#uses=1 type=i32]
  %rend = call i32 (...)* @_ssdm_op_SpecRegionEnd(i8* getelementptr inbounds ([12 x i8]* @.str4, i64 0, i64 0), i32 %rbegin) nounwind, !dbg !2925 ; [#uses=0 type=i32] [debug line = 117:2]
  %i.1 = add nsw i32 %y.assign, 1, !dbg !2926     ; [#uses=1 type=i32] [debug line = 76:41]
  call void @llvm.dbg.value(metadata !{i32 %i.1}, i64 0, metadata !2927), !dbg !2926 ; [debug line = 76:41] [debug variable = i]
  br label %7, !dbg !2926                         ; [debug line = 76:41]

; <label>:23                                      ; preds = %7
  ret void, !dbg !2928                            ; [debug line = 118:1]
}

; [#uses=1]
define internal fastcc zeroext i1 @borders_ok(i32 %y, i32 %x) nounwind uwtable {
  call void @llvm.dbg.value(metadata !{i32 %y}, i64 0, metadata !2929), !dbg !2930 ; [debug line = 18:21] [debug variable = y]
  call void @llvm.dbg.value(metadata !{i32 %x}, i64 0, metadata !2931), !dbg !2932 ; [debug line = 18:28] [debug variable = x]
  %tmp = icmp sgt i32 %y, 0, !dbg !2933           ; [#uses=1 type=i1] [debug line = 19:2]
  %tmp.32 = icmp slt i32 %y, 256, !dbg !2933      ; [#uses=1 type=i1] [debug line = 19:2]
  %or.cond = and i1 %tmp, %tmp.32, !dbg !2933     ; [#uses=1 type=i1] [debug line = 19:2]
  %tmp.33 = icmp sgt i32 %x, 0, !dbg !2933        ; [#uses=1 type=i1] [debug line = 19:2]
  %or.cond1 = and i1 %or.cond, %tmp.33, !dbg !2933 ; [#uses=1 type=i1] [debug line = 19:2]
  %tmp.34 = icmp slt i32 %x, 256, !dbg !2933      ; [#uses=1 type=i1] [debug line = 19:2]
  %. = and i1 %or.cond1, %tmp.34, !dbg !2933      ; [#uses=1 type=i1] [debug line = 19:2]
  ret i1 %., !dbg !2935                           ; [debug line = 20:1]
}
...
!2811 = metadata !{i32 131, i32 9, metadata !2812, metadata !2813}
!2812 = metadata !{i32 786443, metadata !944, i32 129, i32 63, metadata !879, i32 25} ; [ DW_TAG_lexical_block ]
!2813 = metadata !{i32 59, i32 19, metadata !2814, null}
!2814 = metadata !{i32 786443, metadata !2815, i32 57, i32 54, metadata !870, i32 3} ; [ DW_TAG_lexical_block ]
!2815 = metadata !{i32 786443, metadata !2797, i32 57, i32 19, metadata !870, i32 2} ; [ DW_TAG_lexical_block ]
!2816 = metadata !{i32 57, i32 39, metadata !2815, null}
!2817 = metadata !{i32 62, i32 33, metadata !2818, null}
!2818 = metadata !{i32 786443, metadata !2797, i32 62, i32 19, metadata !870, i32 4} ; [ DW_TAG_lexical_block ]
!2819 = metadata !{i32 57, i32 55, metadata !2814, null}
!2820 = metadata !{i32 58, i32 1, metadata !2814, null}
!2821 = metadata !{i32 786689, metadata !944, metadata !"this", metadata !879, i32 16777345, metadata !2822, i32 64, i32 0} ; [ DW_TAG_arg_variable ]
!2822 = metadata !{i32 786447, null, metadata !"", null, i32 0, i64 64, i64 64, i64 0, i32 0, metadata !877} ; [ DW_TAG_pointer_type ]
!2823 = metadata !{i32 129, i32 56, metadata !944, metadata !2813}
!2824 = metadata !{i32 786688, metadata !2812, metadata !"tmp", metadata !879, i32 130, metadata !882, i32 0, i32 0} ; [ DW_TAG_auto_variable ]
!2825 = metadata !{i32 130, i32 22, metadata !2812, metadata !2813}
!2826 = metadata !{i32 132, i32 9, metadata !2812, metadata !2813}
!2827 = metadata !{i32 60, i32 5, metadata !2814, null}
!2828 = metadata !{i32 57, i32 50, metadata !2815, null}
!2829 = metadata !{i32 786688, metadata !2815, metadata !"x", metadata !870, i32 57, metadata !56, i32 0, i32 0} ; [ DW_TAG_auto_variable ]
!2830 = metadata !{i32 62, i32 49, metadata !2831, null}
!2831 = metadata !{i32 786443, metadata !2818, i32 62, i32 48, metadata !870, i32 5} ; [ DW_TAG_lexical_block ]
!2832 = metadata !{i32 63, i32 1, metadata !2831, null}
!2833 = metadata !{i32 129, i32 56, metadata !944, metadata !2834}
!2834 = metadata !{i32 64, i32 19, metadata !2831, null}
!2835 = metadata !{i32 130, i32 22, metadata !2812, metadata !2834}
!2836 = metadata !{i32 131, i32 9, metadata !2812, metadata !2834}
!2837 = metadata !{i32 132, i32 9, metadata !2812, metadata !2834}
!2838 = metadata !{i32 65, i32 5, metadata !2831, null}
!2839 = metadata !{i32 62, i32 44, metadata !2818, null}
!2840 = metadata !{i32 786688, metadata !2818, metadata !"x", metadata !870, i32 62, metadata !56, i32 0, i32 0} ; [ DW_TAG_auto_variable ]
!2841 = metadata !{i32 69, i32 2, metadata !2797, null}
!2842 = metadata !{i32 70, i32 2, metadata !2797, null}
!2843 = metadata !{i32 71, i32 2, metadata !2797, null}
!2844 = metadata !{i32 72, i32 2, metadata !2797, null}
!2845 = metadata !{i32 146, i32 9, metadata !2846, metadata !2847}
!2846 = metadata !{i32 786443, metadata !929, i32 144, i32 79, metadata !879, i32 17} ; [ DW_TAG_lexical_block ]
!2847 = metadata !{i32 85, i32 4, metadata !2848, null}
!2848 = metadata !{i32 786443, metadata !2849, i32 79, i32 3, metadata !870, i32 9} ; [ DW_TAG_lexical_block ]
!2849 = metadata !{i32 786443, metadata !2850, i32 78, i32 17, metadata !870, i32 8} ; [ DW_TAG_lexical_block ]
!2850 = metadata !{i32 786443, metadata !2851, i32 77, i32 2, metadata !870, i32 7} ; [ DW_TAG_lexical_block ]
!2851 = metadata !{i32 786443, metadata !2797, i32 76, i32 16, metadata !870, i32 6} ; [ DW_TAG_lexical_block ]
!2852 = metadata !{i32 89, i32 4, metadata !2848, null}
!2853 = metadata !{i32 98, i32 5, metadata !2854, null}
!2854 = metadata !{i32 786443, metadata !2848, i32 93, i32 4, metadata !870, i32 10} ; [ DW_TAG_lexical_block ]
!2855 = metadata !{i32 76, i32 30, metadata !2851, null}
!2856 = metadata !{i32 77, i32 3, metadata !2850, null}
!2857 = metadata !{i32 78, i32 31, metadata !2849, null}
!2858 = metadata !{i32 79, i32 4, metadata !2848, null}
!2859 = metadata !{i32 80, i32 1, metadata !2848, null}
!2860 = metadata !{i32 786689, metadata !930, metadata !"window", metadata !870, i32 16777240, metadata !933, i32 0, metadata !2861} ; [ DW_TAG_arg_variable ]
!2861 = metadata !{i32 83, i32 24, metadata !2848, null}
!2862 = metadata !{i32 24, i32 31, metadata !930, metadata !2861}
!2863 = metadata !{i32 786689, metadata !930, metadata !"y", metadata !870, i32 33554456, metadata !56, i32 0, metadata !2861} ; [ DW_TAG_arg_variable ]
!2864 = metadata !{i32 24, i32 57, metadata !930, metadata !2861}
!2865 = metadata !{i32 786689, metadata !930, metadata !"x", metadata !870, i32 50331672, metadata !56, i32 0, metadata !2861} ; [ DW_TAG_arg_variable ]
!2866 = metadata !{i32 24, i32 64, metadata !930, metadata !2861}
!2867 = metadata !{i32 28, i32 16, metadata !2868, metadata !2861}
!2868 = metadata !{i32 786443, metadata !2869, i32 28, i32 2, metadata !870, i32 19} ; [ DW_TAG_lexical_block ]
!2869 = metadata !{i32 786443, metadata !930, i32 24, i32 94, metadata !870, i32 18} ; [ DW_TAG_lexical_block ]
!2870 = metadata !{i32 30, i32 9, metadata !2871, metadata !2861}
!2871 = metadata !{i32 786443, metadata !2872, i32 29, i32 32, metadata !870, i32 22} ; [ DW_TAG_lexical_block ]
!2872 = metadata !{i32 786443, metadata !2873, i32 29, i32 4, metadata !870, i32 21} ; [ DW_TAG_lexical_block ]
!2873 = metadata !{i32 786443, metadata !2868, i32 28, i32 30, metadata !870, i32 20} ; [ DW_TAG_lexical_block ]
!2874 = metadata !{i32 31, i32 6, metadata !2875, metadata !2861}
!2875 = metadata !{i32 786443, metadata !2871, i32 30, i32 45, metadata !870, i32 23} ; [ DW_TAG_lexical_block ]
!2876 = metadata !{i32 29, i32 18, metadata !2872, metadata !2861}
!2877 = metadata !{i32 786688, metadata !2869, metadata !"result", metadata !870, i32 26, metadata !56, i32 0, metadata !2861} ; [ DW_TAG_auto_variable ]
!2878 = metadata !{i32 32, i32 5, metadata !2875, metadata !2861}
!2879 = metadata !{i32 29, i32 27, metadata !2872, metadata !2861}
!2880 = metadata !{i32 786688, metadata !2872, metadata !"j", metadata !870, i32 29, metadata !56, i32 0, metadata !2861} ; [ DW_TAG_auto_variable ]
!2881 = metadata !{i32 28, i32 25, metadata !2868, metadata !2861}
!2882 = metadata !{i32 786688, metadata !2868, metadata !"i", metadata !870, i32 28, metadata !56, i32 0, metadata !2861} ; [ DW_TAG_auto_variable ]
!2883 = metadata !{i32 786688, metadata !2797, metadata !"val_out", metadata !870, i32 48, metadata !935, i32 0, i32 0} ; [ DW_TAG_auto_variable ]
!2884 = metadata !{i32 786689, metadata !929, metadata !"this", metadata !879, i32 16777360, metadata !2822, i32 64, i32 0} ; [ DW_TAG_arg_variable ]
!2885 = metadata !{i32 144, i32 48, metadata !929, metadata !2847}
!2886 = metadata !{i32 786688, metadata !2846, metadata !"tmp", metadata !879, i32 145, metadata !882, i32 0, i32 0} ; [ DW_TAG_auto_variable ]
!2887 = metadata !{i32 145, i32 22, metadata !2846, metadata !2847}
!2888 = metadata !{i32 145, i32 31, metadata !2846, metadata !2847}
!2889 = metadata !{i32 88, i32 4, metadata !2848, null}
!2890 = metadata !{i32 92, i32 4, metadata !2848, null}
!2891 = metadata !{i32 129, i32 56, metadata !944, metadata !2892}
!2892 = metadata !{i32 95, i32 14, metadata !2854, null}
!2893 = metadata !{i32 130, i32 22, metadata !2812, metadata !2892}
!2894 = metadata !{i32 131, i32 9, metadata !2812, metadata !2892}
!2895 = metadata !{i32 132, i32 9, metadata !2812, metadata !2892}
!2896 = metadata !{i32 786688, metadata !2797, metadata !"val_in", metadata !870, i32 49, metadata !935, i32 0, i32 0} ; [ DW_TAG_auto_variable ]
!2897 = metadata !{i32 96, i32 5, metadata !2854, null}
!2898 = metadata !{i32 786688, metadata !2797, metadata !"read_count", metadata !870, i32 66, metadata !56, i32 0, i32 0} ; [ DW_TAG_auto_variable ]
!2899 = metadata !{i32 102, i32 28, metadata !2900, null}
!2900 = metadata !{i32 786443, metadata !2854, i32 102, i32 14, metadata !870, i32 11} ; [ DW_TAG_lexical_block ]
!2901 = metadata !{i32 110, i32 28, metadata !2902, null}
!2902 = metadata !{i32 786443, metadata !2854, i32 110, i32 14, metadata !870, i32 15} ; [ DW_TAG_lexical_block ]
!2903 = metadata !{i32 102, i32 42, metadata !2904, null}
!2904 = metadata !{i32 786443, metadata !2900, i32 102, i32 41, metadata !870, i32 12} ; [ DW_TAG_lexical_block ]
!2905 = metadata !{i32 106, i32 7, metadata !2906, null}
!2906 = metadata !{i32 786443, metadata !2907, i32 103, i32 42, metadata !870, i32 14} ; [ DW_TAG_lexical_block ]
!2907 = metadata !{i32 786443, metadata !2904, i32 103, i32 15, metadata !870, i32 13} ; [ DW_TAG_lexical_block ]
!2908 = metadata !{i32 103, i32 29, metadata !2907, null}
!2909 = metadata !{i32 103, i32 43, metadata !2906, null}
!2910 = metadata !{i32 107, i32 6, metadata !2906, null}
!2911 = metadata !{i32 786688, metadata !2907, metadata !"x", metadata !870, i32 103, metadata !56, i32 0, i32 0} ; [ DW_TAG_auto_variable ]
!2912 = metadata !{i32 103, i32 38, metadata !2907, null}
!2913 = metadata !{i32 108, i32 5, metadata !2904, null}
!2914 = metadata !{i32 102, i32 37, metadata !2900, null}
!2915 = metadata !{i32 786688, metadata !2900, metadata !"y", metadata !870, i32 102, metadata !56, i32 0, i32 0} ; [ DW_TAG_auto_variable ]
!2916 = metadata !{i32 110, i32 42, metadata !2917, null}
!2917 = metadata !{i32 786443, metadata !2902, i32 110, i32 41, metadata !870, i32 16} ; [ DW_TAG_lexical_block ]
!2918 = metadata !{i32 113, i32 6, metadata !2917, null}
!2919 = metadata !{i32 114, i32 5, metadata !2917, null}
!2920 = metadata !{i32 110, i32 37, metadata !2902, null}
!2921 = metadata !{i32 786688, metadata !2902, metadata !"y", metadata !870, i32 110, metadata !56, i32 0, i32 0} ; [ DW_TAG_auto_variable ]
!2922 = metadata !{i32 116, i32 3, metadata !2848, null}
!2923 = metadata !{i32 78, i32 42, metadata !2849, null}
!2924 = metadata !{i32 786688, metadata !2849, metadata !"j", metadata !870, i32 78, metadata !56, i32 0, i32 0} ; [ DW_TAG_auto_variable ]
!2925 = metadata !{i32 117, i32 2, metadata !2850, null}
!2926 = metadata !{i32 76, i32 41, metadata !2851, null}
!2927 = metadata !{i32 786688, metadata !2851, metadata !"i", metadata !870, i32 76, metadata !56, i32 0, i32 0} ; [ DW_TAG_auto_variable ]
!2928 = metadata !{i32 118, i32 1, metadata !2797, null}
!2929 = metadata !{i32 786689, metadata !869, metadata !"y", metadata !870, i32 16777234, metadata !56, i32 0, i32 0} ; [ DW_TAG_arg_variable ]
!2930 = metadata !{i32 18, i32 21, metadata !869, null}
!2931 = metadata !{i32 786689, metadata !869, metadata !"x", metadata !870, i32 33554450, metadata !56, i32 0, i32 0} ; [ DW_TAG_arg_variable ]
!2932 = metadata !{i32 18, i32 28, metadata !869, null}
!2933 = metadata !{i32 19, i32 2, metadata !2934, null}
!2934 = metadata !{i32 786443, metadata !869, i32 18, i32 30, metadata !870, i32 0} ; [ DW_TAG_lexical_block ]
!2935 = metadata !{i32 20, i32 1, metadata !869, null}
