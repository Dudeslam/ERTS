...
$(ObjDir)/conv_2d_testbench.cpp_pre.cpp.tb.o : conv_2d_testbench.cpp_pre.cpp.tb.cpp $(ObjDir)/.dir
	$(Echo) "   Compiling conv_2d_testbench.cpp_pre.cpp.tb.cpp" $(AVE_DIR_DLOG)
	$(Verb) $(CC) ${CCFLAG}  -fno-builtin-isinf -fno-builtin-isnan -c $(IFLAG) $(DFLAG) $< -o $@; \

$(ObjDir)/conv_2d.cpp_pre.cpp.tb.o : conv_2d.cpp_pre.cpp.tb.cpp $(ObjDir)/.dir
	$(Echo) "   Compiling conv_2d.cpp_pre.cpp.tb.cpp" $(AVE_DIR_DLOG)
	$(Verb) $(CC) ${CCFLAG}  -fno-builtin-isinf -fno-builtin-isnan -c $(IFLAG) $(DFLAG) $< -o $@; \
