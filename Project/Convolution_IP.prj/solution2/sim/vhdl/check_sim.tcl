...
proc check_tvin_file {} {
    ...
    set rtlfilelist {
         "c.conv_3x3_strm.autotvin_out_stream_V.dat"
         "c.conv_3x3_strm.autotvin_in_stream_V.dat"
         "c.conv_3x3_strm.autotvout_out_stream_V.dat"
    }
...
proc check_tvout_file {} {
    ...
    set rtlfilelist {
         "rtl.conv_3x3_strm.autotvout_out_stream_V.dat"
    }
    foreach rtlfile $rtlfilelist {
        if {[file isfile $rtlfile]} {
        } else {
