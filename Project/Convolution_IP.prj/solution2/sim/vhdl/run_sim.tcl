...
if {[file isfile conv_3x3_strm.autotvin.dat]} {
	file delete -force conv_3x3_strm.autotvin.dat
}

if {[file isfile conv_3x3_strm.autotvout.dat]} {
	file delete -force conv_3x3_strm.autotvout.dat
}
