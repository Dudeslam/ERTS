...
#define AUTOTB_TVOUT_PC_out_stream_V  "../tv/rtldatafile/rtl.conv_3x3_strm.autotvout_out_stream_V.dat"
...
hls::stream<unsigned char > (&in_stream))
{
	...
	if (wrapc_switch_file_token.good())
	{
		...
		if (atoi(AESL_num.c_str()) == AESL_transaction_pc)
		{
			...
			std::vector<sc_bv<8> > out_stream_V_pc_buffer;
			int i = 0;
			...
			if (i > 0)
			{
				// RTL Name: out_stream_V
				{
					// bitslice(7, 0)
					// {
						// celement: out_stream.V(7, 0)
						// {
							sc_lv<8>* out_stream_V_lv0_0_0_1 = new sc_lv<8>[aesl_tmp_1 - aesl_tmp_2];
						// }
					// }
					...
					// bitslice(7, 0)
					{
						...
						// celement: out_stream.V(7, 0)
						{
							...
							for (int i_0 = aesl_tmp_2; i_0 <= aesl_tmp_1 - 1; i_0 += 1)
							{
								...
								{
									out_stream_V_lv0_0_0_1[hls_map_index].range(7, 0) = sc_bv<8>(out_stream_V_pc_buffer[hls_map_index].range(7, 0));
									hls_map_index++;
								}
							}
						}
...
// [call_c_dut] ---------->
		...
		conv_3x3_strm(out_stream, in_stream);
     ...
     aesl_tmp_0.clear();
		...
		sc_bv<8>* out_stream_V_tvout_wrapc_buffer = new sc_bv<8>[aesl_tmp_1 - aesl_tmp_2];
			...
			// bitslice(7, 0)
			{
				...
				// celement: out_stream.V(7, 0)
				{
					...
					for (int i_0 = aesl_tmp_2; i_0 <= aesl_tmp_1 - 1; i_0 += 1)
					{
						...
						if (&(aesl_tmp_0[0]) != NULL) // check the null address if the c port is array or others
						{
							sc_lv<8> out_stream_V_tmp_mem;
							out_stream_V_tmp_mem = aesl_tmp_0[i_0];
							out_stream_V_tvout_wrapc_buffer[hls_map_index].range(7, 0) = out_stream_V_tmp_mem.range(7, 0);
                                 	       hls_map_index++;
						}
					}
				}
		...
		sc_bv<8>* in_stream_V_tvin_wrapc_buffer = new sc_bv<8>[aesl_tmp_4 - aesl_tmp_5];
			...
			// bitslice(7, 0)
			{
				...
				// celement: in_stream.V(7, 0)
				{
					...
					for (int i_0 = 0; i_0 <= aesl_tmp_4 - aesl_tmp_5 - 1; i_0 += 1)
					{
						...
						{
							sc_lv<8> in_stream_V_tmp_mem;
							in_stream_V_tmp_mem = aesl_tmp_3[i_0];
							in_stream_V_tvin_wrapc_buffer[hls_map_index].range(7, 0) = in_stream_V_tmp_mem.range(7, 0);
                                 	       hls_map_index++;
						}
					}
				}
